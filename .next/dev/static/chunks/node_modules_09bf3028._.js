 ...
 */ function(t, e) {
 ...
 - ${i}: ${e}`, r && (a += encodeURI(i) + "=" + encodeURI(e));
        ...
        }, { doc: iP, SVG_NS: iO, win: iE } = V, { attr: iL, extend: iB, fireEvent: iD, isString: iI, objectEach: iz, pick: iR } = tx, iN = (t, e)=>t.substring(0, e) + "…", iW = class {
            constructor(t){
                const e = t.styles;
                ...
                let o = (t, o)=>{
                    ...
                    if (n) {
                        ...
                        for(; a.length;)if (a.length && !this.noWrap && d > 0 && (r.push(t.textContent || ""), t.textContent = a.join(" ").replace(/- /g, "-")), this.truncate(t, void 0, a, 0 === d && c || 0, s, l, (t, e)=>a.slice(0, e).join(" ").replace(/- /g, "-")), c = e.actualWidth, d++, this.lineClamp && d >= this.lineClamp) {
                            a.length && (this.truncate(t, t.textContent || "", void 0, 0, s, l, iN), t.textContent = t.textContent?.replace("…", "") + "…");
                            break;
                        }
                        n.forEach((e)=>{
                            o.insertBefore(e, t);
...
"[project]/node_modules/highcharts/highcharts-more.js [app-client] (ecmascript)", ((__turbopack_context__, module, exports) => {
 ...
 * See www.highcharts.com/license
 */ function(t, e) {
    ("TURBOPACK compile-time truthy", 1) ? module.exports = e(t._Highcharts, t._Highcharts.SeriesRegistry, t._Highcharts.Series, t._Highcharts.Series.types.column, t._Highcharts.Templating, t._Highcharts.Point, t._Highcharts.Color, t._Highcharts.Chart, t._Highcharts.SVGElement, t._Highcharts.StackItem) : "TURBOPACK unreachable";
}("u" < typeof window ? /*TURBOPACK member replacement*/ __turbopack_context__.e : window, (t, e, i, s, a, o, r, n, l, h)=>(()=>{
        "use strict";
        var p, d, c, u, g = {
            28: (t)=>{
                t.exports = l;
        ...
        function m(t) {
            ...
            return g[t](i, i.exports, m), i.exports;
        }
        m.n = (t)=>{
            ...
            for(var i in e)m.o(e, i) && !m.o(t, i) && Object.defineProperty(t, i, {
                enumerable: !0,
                get: e[i]
            });
        }, m.o = (t, e)=>Object.prototype.hasOwnProperty.call(t, e);
        var b = {};
        m.d(b, {
            default: ()=>aA
        });
        ...
        (p = d || (d = {})).getCenter = function() {
            let t = this.options, e = this.chart, i = 2 * (t.slicedOffset || 0), s = e.plotWidth - 2 * i, a = e.plotHeight - 2 * i, o = t.center, r = Math.min(s, a), n = t.thickness, l, h = t.size, p = t.innerSize || 0, d, c;
            "string" == typeof h && (h = parseFloat(h)), "string" == typeof p && (p = parseFloat(p));
            let u = [
                S(o?.[0], "50%"),
                S(o?.[1], "50%"),
                S(h && h < 0 ? void 0 : t.size, "100%"),
                S(p && p < 0 ? void 0 : t.innerSize || 0, "0%")
            ];
            for(!e.angular || this instanceof L() || (u[3] = 0), d = 0; d < 4; ++d)c = u[d], l = d < 2 || 2 === d && /%$/.test(c), u[d] = T(c, [
                s,
                a,
                r,
                u[2]
            ][d]) + (l ? i : 0);
            return u[3] > u[2] && (u[3] = u[2]), A(n) && 2 * n < u[2] && n > 0 && (u[3] = u[2] - 2 * n), w(this, "afterGetCenter", {
                positions: u
            }), u;
        }, p.getStartAndEndRadians = function(t, e) {
        ...
        function I(t) {
            ...
            return t && i.pane.forEach((s)=>{
                D(t.chartX - i.plotLeft, t.chartY - i.plotTop, s.center) && (e = s);
            }), e;
        }
        function E({ clipBox: t }) {
            if (!this.xAxis || !this.yAxis || !this.chart.angular && !this.chart.polar) return;
            let { plotWidth: e, plotHeight: i } = this.chart, s = Math.min(e, i), a = this.xAxis.pane, o = this.yAxis.pane;
            a && a.axis && (t.x += a.center[0] - a.center[2] / s * e / 2), o && o.axis && (t.y += o.center[1] - o.center[2] / s * i / 2);
        }
        function D(t, e, i, s, a) {
            let o = !0, r = i[0], n = i[1], l = 2 * Math.PI, h = Math.sqrt(Math.pow(t - r, 2) + Math.pow(e - n, 2));
            if (Y(s) && Y(a)) {
                let i = Math.atan2(X(e - n, 8), X(t - r, 8));
                i = (i + l) % l, s = (s + l) % l, Math.abs((a = (a + l) % l) - s) > 1e-6 && (o = s > a ? i >= s || i <= a : i >= s && i <= a);
            } else o = !0;
            return h <= Math.ceil(i[2] / 2) && o;
        }
        function z(t) {
            this.polar && (t.options.inverted && ([t.x, t.y] = [
                t.y,
                t.x
            ]), t.isInsidePlot = this.pane.some((e)=>D(t.x, t.y, e.center, e.axis && e.axis.normalizedStartAngleRad, e.axis && e.axis.normalizedEndAngleRad)));
        }
        function O(t) {
            let e = this.chart;
            t.hoverPoint && t.hoverPoint.plotX && t.hoverPoint.plotY && e.hoverPane && !D(t.hoverPoint.plotX, t.hoverPoint.plotY, e.hoverPane.center) && (t.hoverPoint = void 0);
        }
        function H(t) {
            let e = this.chart;
        ...
        class _ {
            ...
            render() {
                ...
                if (i) {
                    let t = Math.max((i = V(i)).length, this.background.length || 0);
                    for(let e = 0; e < t; e++)i[e] && this.axis ? this.renderBackground(q(W, i[e]), e) : this.background[e] && (this.background[e] = this.background[e].destroy(), this.background.splice(e, 1));
                }
            }
            ...
            updateCenter(t) {
                this.center = (t || this.axis || {}).center = C.getCenter.call(this);
            }
            update(t, e) {
                q(!0, this.options, t), this.setOptions(this.options), this.render(), this.chart.axes.forEach(function(t) {
                    t.pane === this && (t.pane = null, t.update({}, e));
                }, this);
            }
        }
        _.compose = function(t, e, i) {
            let s = t.prototype;
            s.getHoverPane || (s.collectionsWithUpdate.push("pane"), s.getHoverPane = I, N(t, "afterIsInsidePlot", z), N(e, "afterGetHoverData", O), N(e, "beforeGetHoverData", H), N(i, "setClip", E));
        };
        let { area: { prototype: { pointClass: U, pointClass: { prototype: K } } } } = M().seriesTypes, { defined: j, isNumber: Z } = x(), $ = class extends U {
            setState() {
                let t = this.state, e = this.series, i = e.chart.polar;
                j(this.plotHigh) || (this.plotHigh = e.yAxis.toPixels(this.high, !0)), j(this.plotLow) || (this.plotLow = this.plotY = e.yAxis.toPixels(this.low, !0)), e.lowerStateMarkerGraphic = e.stateMarkerGraphic, e.stateMarkerGraphic = e.upperStateMarkerGraphic, this.graphic = this.graphics && this.graphics[1], this.plotY = this.plotHigh, i && Z(this.plotHighX) && (this.plotX = this.plotHighX), K.setState.apply(this, arguments), this.state = t, this.plotY = this.plotLow, this.graphic = this.graphics && this.graphics[0], i && Z(this.plotLowX) && (this.plotX = this.plotLowX), e.upperStateMarkerGraphic = e.stateMarkerGraphic, e.stateMarkerGraphic = e.lowerStateMarkerGraphic, e.lowerStateMarkerGraphic = void 0;
                let s = e.modifyMarkerSettings();
                K.setState.apply(this, arguments), e.restoreMarkerSettings(s);
            }
            haloPath() {
                let t = this.series.chart.polar, e = [];
                return this.plotY = this.plotLow, t && Z(this.plotLowX) && (this.plotX = this.plotLowX), this.isInside && (e = K.haloPath.apply(this, arguments)), this.plotY = this.plotHigh, t && Z(this.plotHighX) && (this.plotX = this.plotHighX), this.isTopInside && (e = e.concat(K.haloPath.apply(this, arguments))), e;
            }
            isValid() {
        ...
        class th extends J {
            ...
            getGraphPath(t) {
                let e = [], i = [], s = tt.getGraphPath, a = this.options, o = this.chart.polar, r = o && !1 !== a.connectEnds, n = a.connectNulls, l, h, p, d = a.step;
                for(l = (t = t || this.points).length; l--;){
                    ...
                    h.isNull || r || n || t[l + 1] && !t[l + 1].isNull || i.push(s), p = {
                        polarPlotY: h.polarPlotY,
                        rectPlotX: h.rectPlotX,
                        yBottom: h.yBottom,
                        plotX: tn(h.plotHighX, h.plotX),
                        plotY: h.plotHigh,
                        isNull: h.isNull
                    }, i.push(p), e.push(p), h.isNull || r || n || t[l - 1] && !t[l - 1].isNull || i.push(s);
                }
                let c = s.call(this, t);
                d && (!0 === d && (d = "left"), a.step = ({
                    left: "right",
                ...
                let u = s.call(this, e), g = s.call(this, i);
                a.step = d;
                let f = [].concat(c, u);
                return !this.chart.polar && g[0] && "M" === g[0][0] && (g[0] = [
                    "L",
                    g[0][1],
                    g[0][2]
                ]), this.graphPath = f, this.areaPath = c.concat(g), f.isArea = !0, f.xMap = c.xMap, this.areaPath.xMap = c.xMap, f;
            }
            drawDataLabels() {
                let t, e, i, s, a, o = this.points, r = o.length, n = [], l = this.options.dataLabels, h = this.chart.inverted;
                if (l) {
                    if (to(l) ? (s = l[0] || {
                        enabled: !1
                    }, a = l[1] || {
                        enabled: !1
                    }) : ((s = ta({}, l)).x = l.xHigh, s.y = l.yHigh, (a = ta({}, l)).x = l.xLow, a.y = l.yLow), s.enabled || this.hasDataLabels?.()) {
                        for(t = r; t--;)if (e = o[t]) {
                            let { plotHigh: a = 0, plotLow: o = 0 } = e;
                            i = s.inside ? a < o : a > o, e.y = e.high, e._plotY = e.plotY, e.plotY = a, n[t] = e.dataLabel, e.dataLabel = e.dataLabelUpper, e.below = i, h ? s.align || (s.align = i ? "right" : "left") : s.verticalAlign || (s.verticalAlign = i ? "top" : "bottom");
                        }
                        for(this.options.dataLabels = s, tt.drawDataLabels && tt.drawDataLabels.apply(this, arguments), t = r; t--;)(e = o[t]) && (e.dataLabelUpper = e.dataLabel, e.dataLabel = n[t], delete e.dataLabels, e.y = e.low, e.plotY = e._plotY);
                    }
                    if (a.enabled || this.hasDataLabels?.()) {
                        for(t = r; t--;)if (e = o[t]) {
                            let { plotHigh: t = 0, plotLow: s = 0 } = e;
                            i = a.inside ? t < s : t > s, e.below = !i, h ? a.align || (a.align = i ? "left" : "right") : a.verticalAlign || (a.verticalAlign = i ? "bottom" : "top");
                        }
                        this.options.dataLabels = a, tt.drawDataLabels && tt.drawDataLabels.apply(this, arguments);
                    }
                    if (s.enabled) for(t = r; t--;)(e = o[t]) && (e.dataLabels = [
                        e.dataLabelUpper,
                        e.dataLabel
                    ].filter(function(t) {
                        return !!t;
            ...
            modifyMarkerSettings() {
                ...
                if (this.options.lowMarker) {
                    let { options: { marker: t, lowMarker: e } } = this;
                    this.options.marker = tl(t, e), e.symbol && (this.symbol = e.symbol);
                }
                return t;
            }
            ...
            drawPoints() {
                let t, e, i = this.points.length, s = this.modifyMarkerSettings();
                for(tt.drawPoints.apply(this, arguments), this.restoreMarkerSettings(s), t = 0; t < i;)(e = this.points[t]).graphics = e.graphics || [], e.origProps = {
                    plotY: e.plotY,
                    plotX: e.plotX,
                    isInside: e.isInside,
                    negative: e.negative,
                    zone: e.zone,
                    y: e.y
                }, (e.graphic || e.graphics[0]) && (e.graphics[0] = e.graphic), e.graphic = e.graphics[1], e.plotY = e.plotHigh, ts(e.plotHighX) && (e.plotX = e.plotHighX), e.y = tn(e.high, e.origProps.y), e.negative = e.y < (this.options.threshold || 0), this.zones.length && (e.zone = e.getZone()), this.chart.polar || (e.isInside = e.isTopInside = void 0 !== e.plotY && e.plotY >= 0 && e.plotY <= this.yAxis.len && e.plotX >= 0 && e.plotX <= this.xAxis.len), t++;
                for(tt.drawPoints.apply(this, arguments), t = 0; t < i;)(e = this.points[t]).graphics = e.graphics || [], (e.graphic || e.graphics[1]) && (e.graphics[1] = e.graphic), e.graphic = e.graphics[0], e.origProps && (ta(e, e.origProps), delete e.origProps), t++;
            }
            hasMarkerChanged(t, e) {
                let i = t.lowMarker, s = e.lowMarker || {};
                return i && (!1 === i.enabled || s.symbol !== i.symbol || s.height !== i.height || s.width !== i.width) || super.hasMarkerChanged(t, e);
            }
        }
        th.defaultOptions = tl(J.defaultOptions, {
            lineWidth: 1,
            threshold: null,
            tooltip: {
        ...
        }), ti(th, "afterTranslate", function() {
            "low,high" === this.pointArrayMap.join(",") && this.points.forEach((t)=>{
                let e = t.high, i = t.plotY;
                t.isNull ? t.plotY = void 0 : (t.plotLow = i, t.plotHigh = tr(e) ? this.yAxis.translate(this.dataModify ? this.dataModify.modifyValue(e) : e, !1, !0, void 0, !0) : void 0, this.dataModify && (t.yBottom = t.plotHigh));
            });
        }, {
            order: 0
        }), ti(th, "afterTranslate", function() {
            this.points.forEach((t)=>{
                if (this.chart.polar) this.highToXY(t), t.plotLow = t.plotY, t.tooltipPos = [
                    ((t.plotHighX || 0) + (t.plotLowX || 0)) / 2,
                    ((t.plotHigh || 0) + (t.plotLow || 0)) / 2
                ];
                else {
                    let e = t.pos(!1, t.plotLow), i = t.pos(!1, t.plotHigh);
            ...
            pointValKey: "low",
            setStackedPoints: Q
        }), M().registerSeriesType("arearange", th);
        let tp = th, { spline: { prototype: td } } = M().seriesTypes, { merge: tc, extend: tu } = x();
        class tg extends tp {
        }
        tg.defaultOptions = tc(tp.defaultOptions), tu(tg.prototype, {
            getPointSpline: td.getPointSpline
        }), M().registerSeriesType("areasplinerange", tg);
        ...
        class tL extends tm() {
            ...
            getWhiskerPair(t, e, i, s, a) {
                let o = a.whiskers.strokeWidth(), r = (i, s)=>{
                    let a = tv(i, 2 * t) / 2, r = ty(s, o);
                    return [
                        [
                            "M",
                            ty(e - a),
            ...
            drawPoints() {
                let t, e, i, s, a, o, r, n, l, h, p, d = this.points, c = this.options, u = this.chart, g = u.renderer, f = !1 !== this.doQuartiles, m = this.options.whiskerLength;
                for (let b of d){
                    let d = (n = b.graphic) ? "animate" : "attr", y = b.shapeArgs, x = {}, P = {}, M = {}, v = {}, L = b.color || this.color, k = b.options.whiskerLength || m;
                    if (void 0 !== b.plotY) {
                        let w;
                        l = y.width, p = (h = y.x) + l, t = f ? b.q1Plot : b.lowPlot, e = f ? b.q3Plot : b.lowPlot, i = b.highPlot, s = b.lowPlot, n || (b.graphic = n = g.g("point").add(this.group), b.stem = g.path().addClass("highcharts-boxplot-stem").add(n), m && (b.whiskers = g.path().addClass("highcharts-boxplot-whisker").add(n)), f && (b.box = g.path(r).addClass("highcharts-boxplot-box").add(n)), b.medianShape = g.path(o).addClass("highcharts-boxplot-median").add(n)), u.styledMode || (P.stroke = b.stemColor || c.stemColor || L, P["stroke-width"] = tM(b.stemWidth, c.stemWidth, c.lineWidth), P.dashstyle = b.stemDashStyle || c.stemDashStyle || c.dashStyle, b.stem.attr(P), k && (M.stroke = b.whiskerColor || c.whiskerColor || L, M["stroke-width"] = tM(b.whiskerWidth, c.whiskerWidth, c.lineWidth), M.dashstyle = b.whiskerDashStyle || c.whiskerDashStyle || c.dashStyle, b.whiskers.attr(M)), f && (x.fill = b.fillColor || c.fillColor || L, x.stroke = c.lineColor || L, x["stroke-width"] = c.lineWidth || 0, x.dashstyle = b.boxDashStyle || c.boxDashStyle || c.dashStyle, b.box.attr(x)), v.stroke = b.medianColor || c.medianColor || L, v["stroke-width"] = tM(b.medianWidth, c.medianWidth, c.lineWidth), v.dashstyle = b.medianDashStyle || c.medianDashStyle || c.dashStyle, b.medianShape.attr(v));
                        let A = ty((b.plotX || 0) + (this.pointXOffset || 0) + (this.barW || 0) / 2, b.stem.strokeWidth());
                        if (w = [
                            [
                                "M",
                                A,
                        ...
                        if (k) {
                            let t = l / 2, e = this.getWhiskerPair(t, A, b.upperWhiskerLength ?? c.upperWhiskerLength ?? k, b.lowerWhiskerLength ?? c.lowerWhiskerLength ?? k, b);
                            b.whiskers[d]({
                                d: e
                            });
                        }
                        w = [
                            [
                                "M",
                                h,
                                a = ty(b.medianPlot, b.medianShape.strokeWidth())
                            ],
                            [
                                "L",
                                p,
        ...
        tL.defaultOptions = tP(tm().defaultOptions, {
            threshold: null,
            tooltip: {
            ...
            drawDataLabels: tb,
            setStackedPoints: tb
        }), M().registerSeriesType("boxplot", tL);
        let tk = tL, tw = {
            borderColor: void 0,
            borderWidth: 2,
            className: void 0,
        ...
        let { noop: tT } = x(), { arrayMax: tC, arrayMin: tN, isNumber: tX, merge: tY, pick: tR, stableSort: tI } = x(), tE = class {
            constructor(t, e){
                this.setState = tT, this.init(t, e);
            }
            init(t, e) {
            ...
            drawLegendSymbol(t) {
                let e, i = tR(t.options.itemDistance, 20), s = this.legendItem || {}, a = this.options, o = a.ranges, r = a.connectorDistance;
                if (!o || !o.length || !tX(o[0].value)) {
                ...
                e = (e = r - l + n.width) > 0 ? e : 0, this.maxLabel = n, this.movementX = "left" === a.labels.align ? e : 0, s.labelWidth = h + e + i, s.labelHeight = h + n.height / 2;
            }
            setOptions() {
                let t = this.ranges, e = this.options, i = this.chart.series[e.seriesIndex], s = this.legend.baseline, a = {
                    zIndex: e.zIndex,
                ...
                t.forEach(function(h, p) {
                    l || (a.stroke = tR(h.borderColor, e.borderColor, i.color), a.fill = h.color || e.color, a.fill || (a.fill = i.color, a["fill-opacity"] = n ?? 1), o.stroke = tR(h.connectorColor, e.connectorColor, i.color)), t[p].radius = this.getRangeRadius(h.value), t[p] = tY(t[p], {
                        center: t[0].radius - t[p].radius + s
                    }), l || tY(!0, t[p], {
                        bubbleAttribs: tY(a),
                        connectorAttribs: tY(o),
                        labelAttribs: r
                    });
                }, this);
            }
            getRangeRadius(t) {
                let e = this.options, i = this.options.seriesIndex, s = this.chart.series[i], a = e.ranges[0].value, o = e.ranges[e.ranges.length - 1].value, r = e.minSize, n = e.maxSize;
                return s.getRadius.call(this, o, a, r, n, t);
            }
            render() {
            ...
            renderRange(t) {
                let e = this.ranges[0], i = this.legend, s = this.options, a = s.labels, o = this.chart, r = o.series[s.seriesIndex], n = o.renderer, l = this.symbols, h = l.labels, p = t.center, d = Math.abs(t.radius), c = s.connectorDistance || 0, u = a.align, g = i.options.rtl, f = s.borderWidth, m = s.connectorWidth, b = e.radius || 0, y = p - d - f / 2 + m / 2, x = (y % 1 ? 1 : .5) - (m % 2 ? 0 : .5), P = n.styledMode, M = g || "left" === u ? -c : c;
                "center" === u && (M = 0, s.connectorDistance = 0, t.labelAttribs.align = "center"), l.bubbleItems.push(n.circle(b, p + x, d).attr(P ? {} : t.bubbleAttribs).addClass((P ? "highcharts-color-" + r.colorIndex + " " : "") + "highcharts-bubble-legend-symbol " + (s.className || "")).add(this.legendItem.symbol)), l.connectors.push(n.path(n.crispLine([
                    [
                        "M",
                        b,
                        y
                ...
                ], s.connectorWidth)).attr(P ? {} : t.connectorAttribs).addClass((P ? "highcharts-color-" + this.options.seriesIndex + " " : "") + "highcharts-bubble-legend-connectors " + (s.connectorClassName || "")).add(this.legendItem.symbol));
                let v = n.text(this.formatLabel(t)).attr(P ? {} : t.labelAttribs).css(P ? {} : a.style).addClass("highcharts-bubble-legend-labels " + (s.labels.className || "")).add(this.legendItem.symbol), L = {
                    x: b + M + s.labels.x,
                    y: y + s.labels.y + .4 * v.getBBox().height
                };
                v.attr(L), h.push(v), v.placed = !0, v.alignAttr = L;
            }
            getMaxLabelSize() {
                let t, e;
            ...
            formatLabel(t) {
                let e = this.options, i = e.labels.formatter, s = e.labels.format, { numberFormatter: a } = this.chart;
                return s ? tS().format(s, t, this.chart) : i ? i.call(t) : a(t.value, 1);
            }
            ...
            getRanges() {
                let t = this.legend.bubbleLegend, e = t.chart.series, i = t.options.ranges, s, a, o = Number.MAX_VALUE, r = -Number.MAX_VALUE;
                return e.forEach(function(t) {
                    t.isBubble && !t.ignoreSeries && (a = t.getColumn("z").filter(tX)).length && (o = tR(t.options.zMin, Math.min(o, Math.max(tN(a), !1 === t.options.displayNegative ? t.options.zThreshold : -Number.MAX_VALUE))), r = tR(t.options.zMax, Math.max(r, tC(a))));
                }), s = o === r ? [
                    {
                        value: r
                    }
            ...
            predictBubbleSizes() {
                let t = this.chart, e = t.legend.options, i = e.floating, s = "horizontal" === e.layout, a = s ? t.legend.lastLineHeight : 0, o = t.plotSizeX, r = t.plotSizeY, n = t.series[this.options.seriesIndex], l = n.getPxExtremes(), h = Math.ceil(l.minPxSize), p = Math.ceil(l.maxPxSize), d = Math.min(r, o), c, u = n.options.maxSize;
                return i || !/%$/.test(u) ? c = p : (c = (d + a) * (u = parseFloat(u)) / 100 / (u / 100 + 1), (s && r - c >= o || !s && o - c >= r) && (c = p)), [
                    h,
                    Math.ceil(c)
                ];
            }
        ...
        function tF(t, e, i) {
            let s, a, o, r = this.legend, n = tG(this) >= 0;
            r && r.options.enabled && r.bubbleLegend && r.options.bubbleLegend.autoRanges && n ? (s = r.bubbleLegend.options, a = r.bubbleLegend.predictBubbleSizes(), r.bubbleLegend.updateRanges(a[0], a[1]), s.placed || (r.group.placed = !1, r.allItems.forEach((t)=>{
                (o = t.legendItem || {}).group && (o.group.translateY = void 0);
            })), r.render(), s.placed || (this.getMargins(), this.axes.forEach((t)=>{
                t.setScale(), t.updateNames(), tH(t.ticks, function(t) {
                    t.isNew = !0, t.isNewLabel = !0;
                });
            }), this.getMargins()), s.placed = !0, t.call(this, e, i), r.bubbleLegend.correctSizes(), tU(r, tq(r))) : (t.call(this, e, i), r && r.options.enabled && r.bubbleLegend && (r.render(), tU(r, tq(r))));
        }
        function tG(t) {
            let e = t.series, i = 0;
            for(; i < e.length;){
        ...
        function tq(t) {
            let e = t.allItems, i = [], s = e.length, a, o, r, n = 0, l = 0;
            for(n = 0; n < s; n++)if (o = e[n].legendItem || {}, r = (e[n + 1] || {}).legendItem || {}, o.labelHeight && (e[n].itemHeight = o.labelHeight), e[n] === e[s - 1] || o.y !== r.y) {
                for(i.push({
                    height: 0
                }), a = i[i.length - 1]; l <= n; l++)e[l].itemHeight > a.height && (a.height = e[l].itemHeight);
                a.step = n;
            }
            return i;
        }
        function tV(t) {
            let e = this.bubbleLegend, i = this.options, s = i.bubbleLegend, a = tG(this.chart);
            e && e.ranges && e.ranges.length && (s.ranges.length && (s.autoRanges = !!s.ranges[0].autoRanges), this.destroyItem(e)), a >= 0 && i.enabled && s.enabled && (s.seriesIndex = a, this.bubbleLegend = new tE(s, this), this.bubbleLegend.addToLegend(t.allItems));
        }
        function t_(t) {
            let e;
            if (t.defaultPrevented) return !1;
            let i = t.legendItem, s = this.chart, a = i.visible;
            this && this.bubbleLegend && (i.visible = !a, i.ignoreSeries = a, e = tG(s) >= 0, this.bubbleLegend.visible !== e && (this.update({
                bubbleLegend: {
                    enabled: e
                }
            }), this.bubbleLegend.visible = e), i.visible = a);
        }
        function tU(t, e) {
            let i = t.allItems, s = t.options.rtl, a, o, r, n, l = 0;
            i.forEach((t, i)=>{
                (n = t.legendItem || {}).group && (a = n.group.translateX || 0, o = n.y || 0, ((r = t.movementX) || s && t.ranges) && (r = s ? a - t.options.maxSize / 2 : a + r, n.group.attr({
                    translateX: r
                })), i > e[l].step && l++, n.group.attr({
                    translateY: Math.round(o + e[l].height / 2)
                }), n.y = o + e[l].height / 2);
            });
        }
        let tK = function(t, e) {
            tB(tz, "Series.BubbleLegend") && (tD({
                legend: {
                    bubbleLegend: tw
                }
            }), tW(t.prototype, "drawChartBox", tF), tO(e, "afterGetAllItems", tV), tO(e, "itemClick", t_));
        };
            ...
            haloPath(t) {
                ...
                if (this.series.chart.inverted) {
                    let t = this.pos() || [
                        0,
                        0
                    ], { xAxis: i, yAxis: s, chart: a } = this.series, o = 2 * e;
                    return a.renderer.symbols.circle((i?.len || 0) - t[1] - e, (s?.len || 0) - t[0] - e, o, o);
                }
                return tZ().prototype.haloPath.call(this, e);
            }
        }
        tQ(tJ.prototype, {
            ttBelow: !1
        ...
        function ea() {
            let t = this.len, { coll: e, isXAxis: i, min: s } = this, a = (this.max || 0) - (s || 0), o = 0, r = t, n = t / a, l;
            ("xAxis" === e || "yAxis" === e) && (this.series.forEach((t)=>{
                if (t.bubblePadding && t.reserveSpace()) {
                    ...
                    if (i && ((t.onPoint || t).getRadii(0, 0, t), t.onPoint && (t.radii = t.onPoint.radii)), a > 0) {
                        let i = e.length;
                        for(; i--;)if (et(e[i]) && this.dataMin <= e[i] && e[i] <= this.max) {
                            let a = t.radii && t.radii[i] || 0;
                            o = Math.min((e[i] - s) * n - a, o), r = Math.max((e[i] - s) * n + a, r);
                        }
                    }
                }
            }), l && a > 0 && !this.logarithmic && (r -= t, n *= (t + Math.max(0, o) - Math.min(r, t)) / t, [
                [
                    "min",
                    "userMin",
                    o
                ...
                void 0 === ei(this.options[t[0]], this[t[1]]) && (this[t[0]] += t[2] / n);
            })));
        }
        function eo() {
            let { ticks: t, tickPositions: e, dataMin: i = 0, dataMax: s = 0, categories: a } = this, o = this.options.type;
            if ((a?.length || "category" === o) && this.series.find((t)=>t.bubblePadding)) {
                let a = e.length;
                for(; a--;){
                    let o = t[e[a]], r = o.pos || 0;
                    (r > s || r < i) && o.label?.hide();
                }
            }
        }
        class er extends t5 {
            static compose(t, e, i) {
                tK(e, i), es(t0, "Series.Bubble") && (t8(t, "foundExtremes", ea), t8(t, "afterRender", eo));
            }
            animate(t) {
            ...
            getRadii() {
                let t = this.getColumn("z"), e = this.getColumn("y"), i = [], s, a, o, r = this.chart.bubbleZExtremes, { minPxSize: n, maxPxSize: l } = this.getPxExtremes();
                if (!r) {
                    let t, e = Number.MAX_VALUE, i = -Number.MAX_VALUE;
                    this.chart.series.forEach((s)=>{
                        if (s.bubblePadding && s.reserveSpace()) {
                            let a = (s.onPoint || s).getZExtremes();
                            a && (e = Math.min(ei(e, a.zMin), a.zMin), i = Math.max(ei(i, a.zMax), a.zMax), t = !0);
                        }
                    }), t ? (r = {
                        zMin: e,
                        zMax: i
                ...
                for(a = 0, s = t.length; a < s; a++)o = t[a], i.push(this.getRadius(r.zMin, r.zMax, n, l, o, e && e[a]));
                this.radii = i;
            }
            getRadius(t, e, i, s, a, o) {
                let r = this.options, n = "width" !== r.sizeBy, l = r.zThreshold, h = e - t, p = .5;
                if (null === o || null === a) return null;
                if (et(a)) {
                    if (r.sizeByAbsoluteValue && (a = Math.abs(a - l), e = h = Math.max(e - l, Math.abs(t - l)), t = 0), a < t) return i / 2 - 1;
                    h > 0 && (p = (a - t) / h);
                }
            ...
            markerAttribs(t, e) {
                let i = super.markerAttribs(t, e), { height: s = 0, width: a = 0 } = i;
                return this.chart.inverted ? t7(i, {
                    x: (t.plotX || 0) - a / 2,
                    y: (t.plotY || 0) - s / 2
                }) : i;
            }
            pointAttribs(t, e) {
                let i = this.options.marker, s = i?.fillOpacity, a = t2.prototype.pointAttribs.call(this, t, e);
                return a["fill-opacity"] = s ?? 1, a;
            }
            translate() {
                super.translate.call(this), this.getRadii(), this.translateBubble();
            }
            translateBubble() {
                let { data: t, options: e, radii: i } = this, { minPxSize: s } = this.getPxExtremes(), a = t.length;
                for(; a--;){
                    let o = t[a], r = i ? i[a] : 0;
                    "z" === this.zoneAxis && (o.negative = (o.z || 0) < (e.zThreshold || 0)), et(r) && r >= s / 2 ? (o.marker = t7(o.marker, {
                        radius: r,
                        width: 2 * r,
                        height: 2 * r
                    }), o.dlBox = {
                        ...
                        width: 2 * r,
                        height: 2 * r
                    }) : (o.shapeArgs = o.plotY = o.dlBox = void 0, o.isInside = !1);
                }
            }
            getPxExtremes() {
                ...
                }, i = e(ei(this.options.minSize, 8)), s = Math.max(e(ei(this.options.maxSize, "20%")), i);
                return {
                    minPxSize: i,
                    maxPxSize: s
                };
            ...
            getZExtremes() {
                let t = this.options, e = this.getColumn("z").filter(et);
                if (e.length) {
                    let i = ei(t.zMin, t9(t4(e), !1 === t.displayNegative ? t.zThreshold || 0 : -Number.MAX_VALUE, Number.MAX_VALUE)), s = ei(t.zMax, t6(e));
                    if (et(i) && et(s)) return {
                        zMin: i,
                        zMax: s
                    };
            ...
            searchKDTree(t, e, i, s = t1, a = t1) {
                return s = (t, e, i)=>{
                    let s = t[i] || 0, a = e[i] || 0, o, r = !1;
                    return s === a ? o = t.index > e.index ? t : e : s < 0 && a < 0 ? (o = s - (t.marker?.radius || 0) >= a - (e.marker?.radius || 0) ? t : e, r = !0) : o = s < a ? t : e, [
                        o,
                        r
                    ];
                }, a = (t, e, i)=>!i && t > e || t < e, super.searchKDTree(t, e, i, s, a);
            }
        }
        er.defaultOptions = ee(t5.defaultOptions, {
            dataLabels: {
                formatter: function() {
            ...
            alignDataLabel: t3.alignDataLabel,
            applyZones: t1,
            bubblePadding: !0,
            isBubble: !0,
            keysAffectYAxis: [
        ...
        class ev extends eu {
            setOptions() {
                return eP(!0, arguments[0], {
                    stacking: void 0
                }), eu.prototype.setOptions.apply(this, arguments);
            }
            translate() {
            ...
            afterColumnTranslate() {
                let t, e, i, s, a = this.yAxis, o = this.xAxis, r = o.startAngleRad, n = this.chart, l = this.xAxis.isRadial, h = Math.max(n.chartWidth, n.chartHeight) + 999;
                this.points.forEach((p)=>{
                    let d = p.shapeArgs || {}, c = this.options.minPointLength, u = p.plotY, g = a.translate(p.high, 0, 1, 0, 1);
                    if (ex(g) && ex(u)) if (p.plotHigh = eb(g, -h, h), p.plotLow = eb(u, -h, h), s = p.plotHigh, Math.abs(t = eM(p.rectPlotY, p.plotY) - p.plotHigh) < c ? (e = c - t, t += e, s -= e / 2) : t < 0 && (t *= -1, s -= t), l && this.polar) i = p.barX + r, p.shapeType = "arc", p.shapeArgs = this.polar.arc(s + t, s, i, i + p.pointWidth);
                    else {
                        d.height = t, d.y = s;
                        let { x: e = 0, width: i = 0 } = d;
                        p.shapeArgs = eP(p.shapeArgs, this.crispCol(e, s, i, t)), p.tooltipPos = n.inverted ? [
                            a.len + a.pos - n.plotLeft - s - t / 2,
                            o.len + o.pos - n.plotTop - e - i / 2,
                            t
                        ] : [
                            o.left - n.plotLeft + e + i / 2,
                            a.pos - n.plotTop + s + t / 2,
                            t
                        ];
                    }
                });
        ...
        ev.defaultOptions = eP(eg.defaultOptions, eu.defaultOptions, {
            borderRadius: {
                where: "all"
            },
            pointRange: null,
        ...
        }), em(ev, "afterColumnTranslate", function() {
            ...
            adjustForMissingColumns: ef.adjustForMissingColumns,
            animate: ef.animate,
            crispCol: ef.crispCol,
            drawGraph: ec,
            drawPoints: ef.drawPoints,
            getSymbol: ec,
            drawTracker: ef.drawTracker,
            getColumnMetrics: ef.getColumnMetrics
        }), M().registerSeriesType("columnrange", ev);
        let { column: eL } = M().seriesTypes, { clamp: ek, merge: ew, pick: eA } = x();
        class eS extends eL {
            translate() {
                let t = this.chart, e = this.options, i = this.dense = this.closestPointRange * this.xAxis.transA < 2, s = this.borderWidth = eA(e.borderWidth, +!i), a = this.yAxis, o = e.threshold, r = eA(e.minPointLength, 5), n = this.getColumnMetrics(), l = n.width, h = this.pointXOffset = n.offset, p = this.translatedThreshold = a.getThreshold(o), d = this.barW = Math.max(l, 1 + 2 * s);
                for (let i of (t.inverted && (p -= .5), e.pointPadding && (d = Math.ceil(d)), super.translate(), this.points)){
                    let s = eA(i.yBottom, p), c = 999 + Math.abs(s), u = ek(i.plotY, -c, a.len + c), g = d / 2, f = Math.min(u, s), m = Math.max(u, s) - f, b = i.plotX + h, y, x, P, M, v, L, k, w, A, S, T;
                    e.centerInCategory && (b = this.adjustForMissingColumns(b, l, i, n)), i.barX = b, i.pointWidth = l, i.tooltipPos = t.inverted ? [
                        a.len + a.pos - t.plotLeft - u,
                        this.xAxis.len - b - g,
                        m
                    ] : [
                        b + g,
                        u + a.pos - t.plotTop,
                        m
                    ], y = o + (i.total || i.y), "percent" === e.stacking && (y = o + (i.y < 0) ? -100 : 100);
                    let C = a.toPixels(y, !0);
                    P = (x = t.plotHeight - C - (t.plotHeight - p)) ? g * (f - C) / x : 0, M = x ? g * (f + m - C) / x : 0, L = b - P + g, k = b + P + g, w = b + M + g, A = b - M + g, S = f - r, T = f + m, i.y < 0 && (S = f, T = f + m + r), t.inverted && (v = a.width - f, x = C - (a.width - p), P = g * (C - v) / x, M = g * (C - (v - m)) / x, k = (L = b + g + P) - 2 * P, w = b - M + g, A = b + M + g, S = f, T = f + m - r, i.y < 0 && (T = f + m + r)), i.shapeType = "path", i.shapeArgs = {
                        x: L,
                        y: S,
                        width: k - L,
                        height: m,
        ...
        class eY extends tk {
            ...
            drawDataLabels() {
                ...
                if (eT) for (let e of (eT.prototype.drawDataLabels.call(this), this.points))e.y = e[t];
            }
            toYData(t) {
                return [
                    t.low,
        ...
        eY.defaultOptions = eN(tk.defaultOptions, {
            color: "#000000",
            grouping: !1,
            linkedTo: ":previous",
            tooltip: {
            ...
            pointValKey: "high",
            doQuartiles: !1
        }), M().registerSeriesType("errorbar", eY);
        ...
        class eq extends eE {
            translate() {
                ...
                this.generatePoints(), this.points.forEach((s)=>{
                    let a = eB(e.dial, s.dial), o = eF(a.radius) * i[2] / 200, r = eF(a.baseLength) * o / 100, n = eF(a.rearLength) * o / 100, l = a.baseWidth, h = a.topWidth, p = e.overshoot, d = t.startAngleRad + t.translate(s.y, void 0, void 0, void 0, !0);
                    (eO(p) || !1 === e.wrap) && (p = eO(p) ? p / 180 * Math.PI : 0, d = ez(d, t.startAngleRad - p, t.endAngleRad + p)), d = 180 * d / Math.PI, s.shapeType = "path", s.shapeArgs = {
                        d: a.path || [
                            [
                                "M",
                                -n,
                        ...
                        translateY: i[1],
                        rotation: d
                    }, s.plotX = i[0], s.plotY = i[1], eG(s.y) && t.max - t.min && (s.percentage = (s.y - t.min) / (t.max - t.min) * 100);
                });
            }
            drawPoints() {
                let t = this, e = t.chart, i = t.yAxis.center, s = t.pivot, a = t.options, o = a.pivot, r = e.renderer;
                t.points.forEach((i)=>{
                    let s = i.graphic, o = i.shapeArgs, n = o.d, l = eB(a.dial, i.dial);
                    s ? (s.animate(o), o.d = n) : i.graphic = r[i.shapeType](o).addClass("highcharts-dial").add(t.group), e.styledMode || i.graphic[s ? "animate" : "attr"]({
                    ...
                    translateX: i[0],
                    translateY: i[1]
                }) : o && (t.pivot = r.circle(0, 0, o.radius).attr({
                    zIndex: 2
            ...
            setData(t, e) {
                eE.prototype.setData.call(this, t, !1), this.processData(), this.generatePoints(), eW(e, !0) && this.chart.redraw();
            }
            hasData() {
                return !!this.points.length;
            }
        }
        eq.defaultOptions = eB(eE.defaultOptions, {
            dataLabels: {
                borderColor: "#cccccc",
                borderRadius: 3,
                borderWidth: 1,
            ...
            directTouch: !0,
            drawGraph: eI,
            drawTracker: eD.prototype.drawTracker,
            fixedBox: !0,
            forceDL: !0,
            noSharedTooltip: !0,
            pointClass: class extends eR {
                setState(t) {
                    this.state = t;
                }
            },
        ...
        }), M().registerSeriesType("gauge", eq);
        var eV = m(620), e_ = m.n(eV);
        let { composed: eU } = x(), { addEvent: eK, pushUnique: ej } = x();
        function eZ() {
            let t, e, i, s, a = this;
            a.container && (t = eK(a.container, "mousedown", (t)=>{
                e && e(), i && i(), (s = a.hoverPoint) && s.series && s.series.hasDraggableNodes && s.series.options.draggable && (s.series.onMouseDown(s, t), e = eK(a.container, "mousemove", (t)=>s && s.series && s.series.onMouseMove(s, t)), i = eK(a.container.ownerDocument, "mouseup", (t)=>(e(), i(), s && s.series && s.series.onMouseUp(s, t))));
            })), eK(a, "destroy", function() {
                t();
            });
        }
        let e$ = {
            compose: function(t) {
                ej(eU, "DragNodes") && eK(t, "load", eZ);
            },
            onMouseDown: function(t, e) {
                let { panKey: i } = this.chart.options.chart;
                if (i && e[`${i}Key`]) return;
                let s = this.chart.pointer?.normalize(e) || e;
                t.fixedPosition = {
                    chartX: s.chartX,
                    chartY: s.chartY,
                    plotX: t.plotX,
            ...
            onMouseMove: function(t, e) {
                if (t.fixedPosition && t.inDragMode) {
                    let i, s, a = this.chart, o = a.pointer?.normalize(e) || e, r = t.fixedPosition.chartX - o.chartX, n = t.fixedPosition.chartY - o.chartY, l = a.graphLayoutsLookup;
                    (Math.abs(r) > 5 || Math.abs(n) > 5) && (i = t.fixedPosition.plotX - r, s = t.fixedPosition.plotY - n, a.isInsidePlot(i, s) && (t.plotX = i, t.plotY = s, t.hasDragged = !0, this.redrawHalo(t), l.forEach((t)=>{
                        t.restartSimulation();
                    })));
                }
            },
        ...
        function e8() {
            ...
            if (this.graphLayoutsLookup && !this.pointer?.hasDragged) {
                for(eQ(!1, this), this.graphLayoutsLookup.forEach((t)=>t.start()); !t;)t = !0, this.graphLayoutsLookup.forEach(i);
        ...
        let e6 = function(t) {
            e1(eJ, "GraphLayout") && (e0(t, "afterPrint", e2), e0(t, "beforePrint", e3), e0(t, "predraw", e5), e0(t, "render", e8));
        }, e4 = {}, e9 = {};
        var e7 = m(960), it = m.n(e7);
        let { seriesTypes: { bubble: { prototype: { pointClass: ie } } } } = M(), ii = class extends ie {
            destroy() {
                return this.series?.layout && this.series.layout.removeElementFromCollection(this, this.series.layout.nodes), tZ().prototype.destroy.apply(this, arguments);
            }
            firePointEvent() {
                let t = this.series.options;
                if (this.isParentNode && t.parentNode) {
                    let e = t.allowPointSelect;
                    t.allowPointSelect = t.parentNode.allowPointSelect, tZ().prototype.firePointEvent.apply(this, arguments), t.allowPointSelect = e;
                } else tZ().prototype.firePointEvent.apply(this, arguments);
            }
            select() {
                let t = this.series.chart;
                this.isParentNode ? (t.getSelectedPoints = t.getSelectedParentNodes, tZ().prototype.select.apply(this, arguments), t.getSelectedPoints = it().prototype.getSelectedPoints) : tZ().prototype.select.apply(this, arguments);
            }
            setState(t, e) {
                this?.graphic?.parentGroup?.element && super.setState(t, e);
            }
        }, { isNumber: is } = x(), ia = {
            attractive: function(t, e, i) {
                let s = t.getMass(), a = -i.x * e * this.diffTemperature, o = -i.y * e * this.diffTemperature;
                t.fromNode.fixedPosition || (t.fromNode.plotX -= a * s.fromNode / t.fromNode.degree, t.fromNode.plotY -= o * s.fromNode / t.fromNode.degree), t.toNode.fixedPosition || (t.toNode.plotX += a * s.toNode / t.toNode.degree, t.toNode.plotY += o * s.toNode / t.toNode.degree);
            },
            attractiveForceFunction: function(t, e) {
                return (e - t) / t;
            },
            barycenter: function() {
                let t = this.options.gravitationalConstant || 0, e = (this.barycenter.xFactor - (this.box.left + this.box.width) / 2) * t, i = (this.barycenter.yFactor - (this.box.top + this.box.height) / 2) * t;
            ...
            integrate: function(t, e) {
                let i = -t.options.friction, s = t.options.maxSpeed, a = e.prevX, o = e.prevY, r = (e.plotX + e.dispX - a) * i, n = (e.plotY + e.dispY - o) * i, l = Math.abs, h = l(r) / (r || 1), p = l(n) / (n || 1), d = h * Math.min(s, Math.abs(r)), c = p * Math.min(s, Math.abs(n));
            ...
            barycenter: function() {
                let t, e, i = this.options.gravitationalConstant || 0, s = this.box, a = this.nodes, o = Math.sqrt(a.length);
                for (let r of a)if (!r.fixedPosition) {
                    let a = r.mass * o, n = r.plotX || 0, l = r.plotY || 0, h = r.series, p = h.parentNode;
                    this.resolveSplitSeries(r) && p && !r.isParentNode ? (t = p.plotX || 0, e = p.plotY || 0) : (t = s.width / 2, e = s.height / 2), r.plotX = n - (n - t) * i / a, r.plotY = l - (l - e) * i / a, h.chart.hoverPoint === r && h.redrawHalo && h.halo && h.redrawHalo(r);
                }
            },
            getK: io,
            integrate: ia.integrate,
            repulsive: function(t, e, i, s) {
                let a = e * this.diffTemperature / t.mass / t.degree, o = i.x * a, r = i.y * a;
                t.fixedPosition || (t.plotX += o, t.plotY += r), s.fixedPosition || (s.plotX -= o, s.plotY -= r);
            },
            ...
            attractive: function(t, e, i, s) {
                let a = t.getMass(), o = i.x / s * e, r = i.y / s * e;
                t.fromNode.fixedPosition || (t.fromNode.dispX -= o * a.fromNode / t.fromNode.degree, t.fromNode.dispY -= r * a.fromNode / t.fromNode.degree), t.toNode.fixedPosition || (t.toNode.dispX += o * a.toNode / t.toNode.degree, t.toNode.dispY += r * a.toNode / t.toNode.degree);
            },
            attractiveForceFunction: function(t, e) {
                return t * t / e;
            },
            barycenter: function() {
                let t = this.options.gravitationalConstant, e = this.barycenter.xFactor, i = this.barycenter.yFactor;
                this.nodes.forEach(function(s) {
                    if (!s.fixedPosition) {
                        let a = s.getDegree(), o = a * (1 + a / 2);
                        s.dispX += (e - s.plotX) * t * o / s.degree, s.dispY += (i - s.plotY) * t * o / s.degree;
                    }
                });
            },
            getK: function(t) {
        ...
        class ih {
            ...
            insert(t, e) {
                let i;
                this.isInternal ? this.nodes[this.getBoxPosition(t)].insert(t, e - 1) : (this.isEmpty = !1, this.body ? e ? (this.isInternal = !0, this.divideBox(), !0 !== this.body && (this.nodes[this.getBoxPosition(this.body)].insert(this.body, e - 1), this.body = !0), this.nodes[this.getBoxPosition(t)].insert(t, e - 1)) : ((i = new ih({
                    top: t.plotX || NaN,
                    left: t.plotY || NaN,
                    width: .1,
                    height: .1
                })).body = t, i.isInternal = !1, this.nodes.push(i)) : (this.isInternal = !1, this.body = t));
            }
            updateMassAndCenter() {
                let t = 0, e = 0, i = 0;
                if (this.isInternal) {
        ...
        let ip = class {
            constructor(t, e, i, s){
                this.box = {
                    ...
                    width: i,
                    height: s
                }, this.maxDepth = 25, this.root = new ih(this.box), this.root.isInternal = !0, this.root.isRoot = !0, this.root.divideBox();
            }
            ...
            visitNodeRecursive(t, e, i) {
                ...
                if (t || (t = this.root), t === this.root && e && (s = e(t)), !1 !== s) {
                    for (let a of t.nodes){
                        if (a.isInternal) {
                            if (e && (s = e(a)), !1 === s) continue;
                            this.visitNodeRecursive(a, e, i);
        ...
        class iy {
            ...
            static compose(t) {
                e6(t), e4.euler = il, e4.verlet = ia, e9["reingold-fruchterman"] = iy;
            }
            init(t) {
                this.options = t, this.nodes = [], this.links = [], this.series = [], this.box = {
                    ...
                    width: 0,
                    height: 0
                }, this.setInitialRendering(!0), this.integration = e4[t.integration], this.enableSimulation = t.enableSimulation, this.attractiveForce = ib(t.attractiveForce, this.integration.attractiveForceFunction), this.repulsiveForce = ib(t.repulsiveForce, this.integration.repulsiveForceFunction), this.approximation = t.approximation;
            }
            updateSimulation(t) {
                this.enableSimulation = ib(t, this.options.enableSimulation);
            }
            start() {
            ...
            step() {
                ...
                if (this.applyLimits(), this.temperature = this.coolDown(this.startTemperature, this.diffTemperature, this.currentStep), this.prevSystemTemperature = this.systemTemperature, this.systemTemperature = this.getSystemTemperature(), this.enableSimulation) {
                    ...
                    this.maxIterations-- && isFinite(this.temperature) && !this.isStable() ? (this.simulation && id.cancelAnimationFrame(this.simulation), this.simulation = id.requestAnimationFrame(()=>this.step())) : (this.simulation = !1, this.series.forEach((t)=>{
                        im(t, "afterSimulation");
                    }));
                }
            }
            stop() {
            ...
            setMaxIterations(t) {
                this.maxIterations = ib(t, this.options.maxIterations);
            }
            setTemperature() {
            ...
            initPositions() {
                ...
                if (ig(t)) for (let e of (t.call(this), this.nodes))iu(e.prevX) || (e.prevX = e.plotX), iu(e.prevY) || (e.prevY = e.plotY), e.dispX = 0, e.dispY = 0;
                else "circle" === t ? this.setCircularPositions() : this.setRandomPositions();
            }
            setCircularPositions() {
                let t, e = this.box, i = this.nodes, s = 2 * Math.PI / (i.length + 1), a = i.filter(function(t) {
                    return 0 === t.linksTo.length;
                }), o = {}, r = this.options.initialPositionRadius, n = (t)=>{
                    for (let e of t.linksFrom || [])o[e.toNode.id] || (o[e.toNode.id] = !0, l.push(e.toNode), n(e.toNode));
                }, l = [];
                for (let t of a)l.push(t), n(t);
                if (l.length) for (let t of i)-1 === l.indexOf(t) && l.push(t);
                else l = i;
                for(let i = 0, a = l.length; i < a; ++i)(t = l[i]).plotX = t.prevX = ib(t.plotX, e.width / 2 + r * Math.cos(i * s)), t.plotY = t.prevY = ib(t.plotY, e.height / 2 + r * Math.sin(i * s)), t.dispX = 0, t.dispY = 0;
            }
            setRandomPositions() {
                let t, e = this.box, i = this.nodes, s = i.length + 1, a = (t)=>{
                    let e = t * t / Math.PI;
                    return e - Math.floor(e);
                };
                for(let o = 0, r = i.length; o < r; ++o)(t = i[o]).plotX = t.prevX = ib(t.plotX, e.width * a(o)), t.plotY = t.prevY = ib(t.plotY, e.height * a(s + o)), t.dispX = 0, t.dispY = 0;
            }
            force(t, ...e) {
            ...
            barnesHutApproximation(t, e) {
                let i, s, a = this.getDistXY(t, e), o = this.vectorLength(a);
                return t !== e && 0 !== o && (e.isInternal ? e.boxSize / o < this.options.theta && 0 !== o ? (s = this.repulsiveForce(o, this.k), this.force("repulsive", t, s * e.mass, a, o), i = !1) : i = !0 : (s = this.repulsiveForce(o, this.k), this.force("repulsive", t, s * e.mass, a, o))), i;
            }
            repulsiveForces() {
                if ("barnes-hut" === this.approximation) for (let t of this.nodes)this.quadTree.visitNodeRecursive(null, (e)=>this.barnesHutApproximation(t, e));
                else {
                    let t, e, i;
                    for (let s of this.nodes)for (let a of this.nodes)s === a || s.fixedPosition || (i = this.getDistXY(s, a), 0 !== (e = this.vectorLength(i)) && (t = this.repulsiveForce(e, this.k), this.force("repulsive", s, t * a.mass, i, e)));
                }
            }
            attractiveForces() {
                let t, e, i;
            ...
            applyLimitBox(t, e) {
                let i = t.radius;
                t.plotX = ic(t.plotX, e.left + i, e.width - i), t.plotY = ic(t.plotY, e.top + i, e.height - i);
            }
            coolDown(t, e, i) {
                return t - e * i;
            }
            ...
            getDistXY(t, e) {
                let i = t.plotX - e.plotX, s = t.plotY - e.plotY;
                return {
                    x: i,
                    y: s,
                    absX: Math.abs(i),
        ...
        class iw extends ix {
            ...
            static compose(t) {
                ix.compose(t), e4.packedbubble = ir, e9.packedbubble = iw;
                let e = t.prototype;
                e.getSelectedParentNodes || (iP(t, "beforeRedraw", ik), e.getSelectedParentNodes = iL), e.allParentNodes || (e.allParentNodes = []);
            }
            beforeStep() {
            ...
            setCircularPositions() {
                let t = this.box, e = [
                    ...this.nodes,
                    ...this?.chart?.allParentNodes || []
                ], i = 2 * Math.PI / (e.length + 1), s = this.options.initialPositionRadius, a, o, r = 0;
                for (let n of e)this.resolveSplitSeries(n) && !n.isParentNode ? (a = n.series.parentNode.plotX, o = n.series.parentNode.plotY) : (a = t.width / 2, o = t.height / 2), n.plotX = n.prevX = iv(n.plotX, a + s * Math.cos(n.index || r * i)), n.plotY = n.prevY = iv(n.plotY, o + s * Math.sin(n.index || r * i)), n.dispX = 0, n.dispY = 0, r++;
            }
            repulsiveForces() {
                let { options: t, k: e } = this, { bubblePadding: i = 0, seriesInteraction: s } = t, a = [
                    ...this.nodes,
                    ...this?.chart?.allParentNodes || []
                ];
                for (let t of a){
                    let o = t.series, r = t.fixedPosition, n = (t.marker?.radius || 0) + i;
                    for (let i of (t.degree = t.mass, t.neighbours = 0, a)){
                        let a = i.series;
                        if (t !== i && !r && (s || o === a) && !(o === a && (i.isParentNode || t.isParentNode))) {
                            let s, a = this.getDistXY(t, i), o = this.vectorLength(a) - (n + (i.marker?.radius || 0));
                            o < 0 && (t.degree += .01, s = this.repulsiveForce(-o / Math.sqrt(++t.neighbours), e, t, i) * i.mass), this.force("repulsive", t, s || 0, a, i, o);
                        }
                    }
                }
            }
            resolveSplitSeries(t) {
                ...
                return !iM(e) && t.series.chart?.options?.plotOptions?.packedbubble?.layoutAlgorithm?.splitSeries || e || !1;
            }
            applyLimitBox(t, e) {
                let i, s;
                this.resolveSplitSeries(t) && !t.isParentNode && this.options.parentNodeLimit && (i = this.getDistXY(t, t.series.parentNode), (s = t.series.parentNodeRadius - t.marker.radius - this.vectorLength(i)) < 0 && s > -2 * t.marker.radius && (t.plotX -= .01 * i.x, t.plotY -= .01 * i.y)), super.applyLimitBox(t, e);
            }
        }
        e9.packedbubble = iw;
        ...
        function iD(t, e) {
            ...
            let i = this.renderer.url, s = this.text || this, a = s.textPath, { attributes: o, enabled: r } = e;
            if (t = t || a && a.path, a && a.undo(), t && r) {
                let e = iX(s, "afterModifyTree", (e)=>{
                    if (t && r) {
                        let a = t.attr("id");
                        a || t.attr("id", a = iR());
                        let r = {
                        ...
                        iI(o.dx) && (r.dx = o.dx, delete o.dx), iI(o.dy) && (r.dy = o.dy, delete o.dy), s.attr(r), this.attr({
                            transform: ""
        ...
        function iz(t) {
            let e = t.bBox, i = this.element?.querySelector("textPath");
            if (i) {
                let t = [], { b: s, h: a } = this.renderer.fontMetrics(this.element), o = a - s, r = RegExp('(<tspan>|<tspan(?!\\sclass="highcharts-br")[^>]*>|<\\/tspan>)', "g"), n = i.innerHTML.replace(r, "").split(/<tspan class="highcharts-br"[^>]*>/), l = n.length, h = (t, e)=>{
                    let { x: a, y: r } = e, n = (i.getRotationOfChar(t) - 90) * iN, l = Math.cos(n), h = Math.sin(n);
                    return [
                        [
                            a - o * l,
                            r - o * h
                ...
                for(let e = 0, s = 0; s < l; s++){
                    let a = n[s].length;
                    for(let o = 0; o < a; o += 5)try {
                        let a = e + o + s, [r, n] = h(a, i.getStartPositionOfChar(a));
                        0 === o ? (t.push(n), t.push(r)) : (0 === s && t.unshift(n), s === l - 1 && t.push(r));
                    } catch  {
                        break;
                    }
                    e += a - 1;
                    try {
                        let a = e + s, o = i.getEndPositionOfChar(a), [r, n] = h(a, o);
        ...
        function iO(t) {
            let e = t.labelOptions, i = t.point, s = e[i.formatPrefix + "TextPath"] || e.textPath;
        ...
        let { parse: iH } = e_(), { noop: iB } = x(), { series: { prototype: iW }, seriesTypes: { bubble: iF } } = M(), { initDataLabels: iG, initDataLabelsDefer: iq } = {
            initDataLabels: function() {
                let t = this.options.dataLabels;
                if (!this.dataLabelsGroup) {
                    let e = this.initDataLabelsGroup(0, t);
                    return !this.chart.styledMode && t?.style && e.css(t.style), e.attr({
                        opacity: 0
                    }), this.visible && (this.options.animation && t?.animation ? e.animate({
                        opacity: 1
                    }, t.animation) : e.attr({
                        opacity: 1
                    }), e.show()), e;
            ...
            initDataLabelsDefer: function() {
                let t = this.options.dataLabels;
                t?.defer && this.options.layoutAlgorithm?.enableSimulation ? iA(()=>{
                    this.deferDataLabels = !1;
                }, t ? iS(t.animation).defer : 0) : this.deferDataLabels = !1;
            }
        }, { addEvent: iV, clamp: i_, defined: iU, extend: iK, fireEvent: ij, isArray: iZ, isNumber: i$, merge: iQ, pick: iJ } = x();
        ({
            compose: function(t) {
                iX(t, "afterGetBBox", iz), iX(t, "beforeAddingDataLabel", iO);
                let e = t.prototype;
                e.setTextPath || (e.setTextPath = iD);
            }
        }).compose(iC());
        class i0 extends iF {
            constructor(){
            ...
            static compose(t, e, i) {
                iF.compose(t, e, i), e$.compose(e), iw.compose(e);
            }
            accumulateAllPoints() {
                let t = this.chart, e = [];
                for (let i of t.series)if (i.is("packedbubble") && i.reserveSpace()) {
                    let t = i.getColumn("value");
            ...
            addLayout() {
                let t = this.options.layoutAlgorithm = this.options.layoutAlgorithm || {}, e = t.type || "packedbubble", i = this.chart.options.chart, s = this.chart.graphLayoutsStorage, a = this.chart.graphLayoutsLookup, o;
                s || (this.chart.graphLayoutsStorage = s = {}, this.chart.graphLayoutsLookup = a = []), (o = s[e]) || (t.enableSimulation = iU(i.forExport) ? !i.forExport : t.enableSimulation, s[e] = o = new e9[e], o.init(t), a.splice(o.index, 0, o)), this.layout = o, this.points.forEach((t)=>{
                    t.mass = 2, t.degree = 1, t.collisionNmb = 1;
                }), o.setArea(0, 0, this.chart.plotWidth, this.chart.plotHeight), o.addElementsToCollection([
                    this
                ], o.series), o.addElementsToCollection(this.points, o.nodes);
            }
            addSeriesLayout() {
                let t = this.options.layoutAlgorithm = this.options.layoutAlgorithm || {}, e = t.type || "packedbubble", i = this.chart.graphLayoutsStorage, s = this.chart.graphLayoutsLookup, a = iQ(t, t.parentNodeOptions, {
                    enableSimulation: this.layout.options.enableSimulation
                }), o = i[e + "-series"];
                o || (i[e + "-series"] = o = new e9[e], o.init(a), s.splice(o.index, 0, o)), this.parentNodeLayout = o, this.createParentNodes();
            }
            calculateParentRadius() {
                let t = this.seriesBox();
                this.parentNodeRadius = i_(Math.sqrt(2 * this.parentNodeMass / Math.PI) + 20, 20, t ? Math.max(Math.sqrt(Math.pow(t.width, 2) + Math.pow(t.height, 2)) / 2 + 20, 20) : Math.sqrt(2 * this.parentNodeMass / Math.PI) + 20), this.parentNode && (this.parentNode.marker.radius = this.parentNode.radius = this.parentNodeRadius);
            }
            calculateZExtremes() {
                let t = this.chart.series, e = this.options.zMin, i = this.options.zMax, s = 1 / 0, a = -1 / 0;
                return e && i ? [
                    e,
                    i
                ] : (t.forEach((t)=>{
                    t.getColumn("value").forEach((t)=>{
                        iU(t) && (t > a && (a = t), t < s && (s = t));
                    });
                }), [
                    e = iJ(e, s),
                    i = iJ(i, a)
            ...
            checkOverlap(t, e) {
                let i = t[0] - e[0], s = t[1] - e[1];
                return Math.sqrt(i * i + s * s) - Math.abs(t[2] + e[2]) < -.001;
            }
            createParentNodes() {
                let t = this.pointClass, e = this.chart, i = this.parentNodeLayout, s = this.layout.options, a, o = this.parentNode, r = {
                    radius: this.parentNodeRadius,
                    lineColor: this.color,
                    fillColor: iH(this.color).brighten(.4).get()
                };
                s.parentNodeOptions && (r = iQ(s.parentNodeOptions.marker || {}, r)), this.parentNodeMass = 0, this.points.forEach((t)=>{
                    this.parentNodeMass += Math.PI * Math.pow(t.marker.radius, 2);
                }), this.calculateParentRadius(), i.nodes.forEach((t)=>{
                    t.seriesIndex === this.index && (a = !0);
                }), i.setArea(0, 0, e.plotWidth, e.plotHeight), a || (o || (o = new t(this, {
                ...
                }), this.chart.allParentNodes.push(o)), this.parentNode && (o.plotX = this.parentNode.plotX, o.plotY = this.parentNode.plotY), this.parentNode = o, i.addElementsToCollection([
                    this
                ], i.series), i.addElementsToCollection([
                    o
                ], i.nodes));
            }
            deferLayout() {
            ...
            drawDataLabels() {
                !this.deferDataLabels && (iW.drawDataLabels.call(this, this.points), this.parentNode && (this.parentNode.formatPrefix = "parentNode", iW.drawDataLabels.call(this, [
                    this.parentNode
                ])));
            }
            drawGraph() {
                if (!this.layout || !this.layout.options.splitSeries) return;
                let t = this.chart, e = this.layout.options.parentNodeOptions.marker, i = {
                    fill: e.fillColor || iH(this.color).brighten(.4).get(),
                    opacity: e.fillOpacity,
                    stroke: e.lineColor || this.color,
                    "stroke-width": iJ(e.lineWidth, this.options.lineWidth)
                }, s = {};
                this.parentNodesGroup = this.plotGroup("parentNodesGroup", "parentNode", this.visible ? "inherit" : "hidden", .1, t.seriesGroup), this.group?.attr({
                    zIndex: 2
                }), this.calculateParentRadius(), this.parentNode && iU(this.parentNode.plotX) && iU(this.parentNode.plotY) && iU(this.parentNodeRadius) && (s = iQ({
            ...
            drawTracker() {
                ...
                super.drawTracker(), e && (t = iZ(e.dataLabels) ? e.dataLabels : e.dataLabel ? [
                    e.dataLabel
                ] : [], e.graphic && (e.graphic.element.point = e), t.forEach((t)=>{
                    (t.div || t.element).point = e;
                }));
            }
            getPointRadius() {
                let t, e, i, s, a = this.chart, o = a.plotWidth, r = a.plotHeight, n = this.options, l = n.useSimulation, h = Math.min(o, r), p = {}, d = [], c = a.allDataPoints || [], u = c.length;
                [
                    "minSize",
                    "maxSize"
                ].forEach((t)=>{
                    let e = parseInt(n[t], 10), i = /%$/.test(n[t]);
                    p[t] = i ? h * e / 100 : e * Math.sqrt(u);
                }), a.minRadius = t = p.minSize / Math.sqrt(u), a.maxRadius = e = p.maxSize / Math.sqrt(u);
                let g = l ? this.calculateZExtremes() : [
                    t,
                    e
                ];
                c.forEach((a, o)=>{
                    i = l ? i_(a[2], g[0], g[1]) : a[2], 0 === (s = this.getRadius(g[0], g[1], t, e, i)) && (s = null), c[o][2] = s, d.push(s);
                }), this.radii = d;
            }
            init() {
            ...
            onMouseUp(t) {
                if (t.fixedPosition && !t.removed) {
                    let e, i = this.layout, s = this.parentNodeLayout;
                    !t.isParentNode && s && i.options.dragBetweenSeries && s.nodes.forEach((s)=>{
                        t && t.marker && s !== t.series.parentNode && (e = i.getDistXY(t, s), i.vectorLength(e) - s.marker.radius - t.marker.radius < 0 && (s.series.addPoint(iQ(t.options, {
                            plotX: t.plotX,
                            plotY: t.plotY
                        }), !1), i.removeElementFromCollection(t, i.nodes), t.remove()));
                    }), e$.onMouseUp.apply(this, arguments);
                }
            }
            placeBubbles(t) {
                let e = this.checkOverlap, i = this.positionBubble, s = [], a = 1, o = 0, r = 0, n, l = [], h, p = t.sort((t, e)=>e[2] - t[2]);
                if (p.length) {
                    if (s.push([
                        [
                            0,
                    ...
                    ]), h = 2; h < p.length; h++)p[h][2] = p[h][2] || 1, e(n = i(s[a][o], s[a - 1][r], p[h]), s[a][0]) ? (s.push([]), r = 0, s[a + 1].push(i(s[a][o], s[a][0], p[h])), a++, o = 0) : a > 1 && s[a - 1][r + 1] && e(n, s[a - 1][r + 1]) ? (r++, s[a].push(i(s[a][o], s[a - 1][r], p[h])), o++) : (o++, s[a].push(n));
                    this.chart.stages = s, this.chart.rawPositions = [].concat.apply([], s), this.resizeRadius(), l = this.chart.rawPositions;
                }
                return l;
            }
            pointAttribs(t, e) {
                let i = this.options, s = t && t.isParentNode, a = i.marker;
                s && i.layoutAlgorithm && i.layoutAlgorithm.parentNodeOptions && (a = i.layoutAlgorithm.parentNodeOptions.marker);
                let o = a.fillOpacity, r = iW.pointAttribs.call(this, t, e);
                return 1 !== o && (r["fill-opacity"] = o), r;
            }
            positionBubble(t, e, i) {
                let s = Math.asin, a = Math.acos, o = Math.pow, r = Math.abs, n = (0, Math.sqrt)(o(t[0] - e[0], 2) + o(t[1] - e[1], 2)), l = a((o(n, 2) + o(i[2] + e[2], 2) - o(i[2] + t[2], 2)) / (2 * (i[2] + e[2]) * n)), h = s(r(t[0] - e[0]) / n), p = (t[1] - e[1] < 0 ? 0 : Math.PI) + l + h * ((t[0] - e[0]) * (t[1] - e[1]) < 0 ? 1 : -1), d = Math.cos(p), c = Math.sin(p);
                return [
                    e[0] + (e[2] + i[2]) * c,
                    e[1] - (e[2] + i[2]) * d,
                    i[2],
            ...
            render() {
                let t = [];
                iW.render.apply(this, arguments), !this.options.dataLabels.allowOverlap && (this.data.forEach((e)=>{
                    iZ(e.dataLabels) && e.dataLabels.forEach((e)=>{
                        t.push(e);
                    });
                }), this.options.useSimulation && this.chart.hideOverlappingLabels(t));
            }
            resizeRadius() {
                let t, e, i, s, a, o = this.chart, r = o.rawPositions, n = Math.min, l = Math.max, h = o.plotLeft, p = o.plotTop, d = o.plotHeight, c = o.plotWidth;
                for (let o of (t = i = 1 / 0, e = s = -1 / 0, r))a = o[2], t = n(t, o[0] - a), e = l(e, o[0] + a), i = n(i, o[1] - a), s = l(s, o[1] + a);
                let u = [
                    e - t,
                    s - i
                ], g = [
                ...
                if (Math.abs(f - 1) > 1e-10) {
                    ...
                    this.placeBubbles(r);
                } else o.diffY = d / 2 + p - i - (s - i) / 2, o.diffX = c / 2 + h - t - (e - t) / 2;
            }
            seriesBox() {
                let t, e = this.chart, i = this.data, s = Math.max, a = Math.min, o = [
                    e.plotLeft,
                ...
                return i.forEach((e)=>{
                    iU(e.plotX) && iU(e.plotY) && e.marker.radius && (t = e.marker.radius, o[0] = a(o[0], e.plotX - t), o[1] = s(o[1], e.plotX + t), o[2] = a(o[2], e.plotY - t), o[3] = s(o[3], e.plotY + t));
                }), i$(o.width / o.height) ? o : null;
            }
            setVisible() {
                let t = this;
                iW.setVisible.apply(t, arguments), t.parentNodeLayout && t.graph ? t.visible ? (t.graph.show(), t.parentNode.dataLabel && t.parentNode.dataLabel.show()) : (t.graph.hide(), t.parentNodeLayout.removeElementFromCollection(t.parentNode, t.parentNodeLayout.nodes), t.parentNode.dataLabel && t.parentNode.dataLabel.hide()) : t.layout && (t.visible ? t.layout.addElementsToCollection(t.points, t.layout.nodes) : t.points.forEach((e)=>{
                    t.layout.removeElementFromCollection(e, t.layout.nodes);
                }));
            }
            translate() {
                let t, e, i, s = this.chart, a = this.data, o = this.index, r = this.options.useSimulation;
                for (let n of (this.generatePoints(), iU(s.allDataPoints) || (s.allDataPoints = this.accumulateAllPoints(), this.getPointRadius()), r ? i = s.allDataPoints : (i = this.placeBubbles(s.allDataPoints), this.options.draggable = !1), i))n[3] === o && (t = a[n[4]], e = iJ(n[2], void 0), r || (t.plotX = n[0] - s.plotLeft + s.diffX, t.plotY = n[1] - s.plotTop + s.diffY), i$(e) && (t.marker = iK(t.marker, {
                    radius: e,
                    width: 2 * e,
                    height: 2 * e
                }), t.radius = e));
                r && this.deferLayout(), ij(this, "afterTranslate");
            }
        }
        i0.defaultOptions = iQ(iF.defaultOptions, {
            minSize: "10%",
            maxSize: "50%",
            sizeBy: "area",
            zoneAxis: "y",
            ...
            initDataLabels: iG,
            alignDataLabel: iW.alignDataLabel,
            indexateNodes: iB,
            onMouseDown: e$.onMouseDown,
            onMouseMove: e$.onMouseMove,
            redrawHalo: e$.redrawHalo,
            searchPoint: iB
        }), M().registerSeriesType("packedbubble", i0);
        let { noop: i1 } = x(), { area: i2, line: i3, scatter: i5 } = M().seriesTypes, { extend: i8, merge: i6 } = x();
        class i4 extends i5 {
            getGraphPath() {
                let t = i3.prototype.getGraphPath.call(this), e = t.length + 1;
                for(; e--;)(e === t.length || "M" === t[e][0]) && e > 0 && t.splice(e, 0, [
                    "Z"
                ]);
        ...
        i4.defaultOptions = i6(i5.defaultOptions, {
            marker: {
                enabled: !1,
                states: {
                    hover: {
            ...
            type: "polygon",
            drawTracker: i3.prototype.drawTracker,
            setStackedPoints: i1
        }), M().registerSeriesType("polygon", i4);
        let { defaultOptions: i9 } = x(), { noop: i7 } = x(), { addEvent: st, extend: se, isObject: si, merge: ss, relativeLength: sa } = x(), so = {
            radius: 0,
            scope: "stack",
            where: void 0
        }, sr = i7, sn = i7;
        function sl(t, e, i, s, a = {}) {
            let o = sr(t, e, i, s, a), { brStart: r = !0, brEnd: n = !0, innerR: l = 0, r: h = i, start: p = 0, end: d = 0 } = a;
            if (a.open || !a.borderRadius) return o;
            let c = d - p, u = Math.sin(c / 2), g = Math.max(Math.min(sa(a.borderRadius || 0, h - l), (h - l) / 2, h * u / (1 + u)), 0), f = Math.min(g, c / Math.PI * 2 * l), m = o.length - 1;
            for(; m--;)(r || 0 !== m && 3 !== m) && (n || 1 !== m && 2 !== m) && !function(t, e, i) {
                let s, a, o, r = t[e], n = t[e + 1];
                if ("Z" === n[0] && (n = t[0]), ("M" === r[0] || "L" === r[0]) && "A" === n[0] ? (s = r, a = n, o = !0) : "A" === r[0] && ("M" === n[0] || "L" === n[0]) && (s = n, a = r), s && a && a.params) {
                    let r = a[1], n = a[5], l = a.params, { start: h, end: p, cx: d, cy: c } = l, u = n ? r - i : r + i, g = u ? Math.asin(i / u) : 0, f = n ? g : -g, m = Math.cos(g) * u;
                    o ? (l.start = h + f, s[1] = d + m * Math.cos(h), s[2] = c + m * Math.sin(h), t.splice(e + 1, 0, [
                        "A",
                        i,
                        i,
                        0,
                        0,
                        1,
                        d + r * Math.cos(l.start),
                        c + r * Math.sin(l.start)
                    ])) : (l.end = p - f, a[6] = d + r * Math.cos(l.end), a[7] = c + r * Math.sin(l.end), t.splice(e + 1, 0, [
                        "A",
                        i,
                        i,
                        0,
                        ...
                        d + m * Math.cos(p),
                        c + m * Math.sin(p)
                    ])), a[4] = Math.abs(l.end - l.start) < Math.PI ? 0 : 1;
                }
            }(o, m, m > 1 ? f : g);
            return o;
        }
        function sh() {
            if (this.options.borderRadius && !(this.chart.is3d && this.chart.is3d())) {
                let { options: t, yAxis: e } = this, i = "percent" === t.stacking, s = i9.plotOptions?.[this.type]?.borderRadius, a = sp(t.borderRadius, si(s) ? s : {}), o = e.options.reversed;
                for (let s of this.points){
                    let { shapeArgs: r } = s;
                    if ("roundedRect" === s.shapeType && r) {
                        let { width: n = 0, height: l = 0, y: h = 0 } = r, p = h, d = l;
                        if ("stack" === a.scope && s.stackTotal) {
                            let a = e.translate(i ? 100 : s.stackTotal, !1, !0, !1, !0), o = e.translate(t.threshold || 0, !1, !0, !1, !0), r = this.crispCol(0, Math.min(a, o), 0, Math.abs(a - o));
                            p = r.y, d = r.height;
                        }
                        let c = (s.negative ? -1 : 1) * (o ? -1 : 1) == -1, u = a.where;
                        !u && this.is("waterfall") && Math.abs((s.yBottom || 0) - (this.translatedThreshold || 0)) > this.borderWidth && (u = "all"), u || (u = "end");
                        let g = Math.min(sa(a.radius, n), n / 2, "all" === u ? l / 2 : 1 / 0) || 0;
                        "end" === u && (c && (p -= g), d += g), se(r, {
                            brBoxHeight: d,
                            brBoxY: p,
                            r: g
                        });
        ...
        function sd() {
            let t = sp(this.options.borderRadius);
            for (let e of this.points){
                let i = e.shapeArgs;
                i && (i.borderRadius = sa(t.radius, (i.r || 0) - (i.innerR || 0)));
            }
        }
        function sc(t, e, i, s, a = {}) {
            let o = sn(t, e, i, s, a), { r = 0, brBoxHeight: n = s, brBoxY: l = e } = a, h = e - l, p = l + n - (e + s), d = h - r > -.1 ? 0 : r, c = p - r > -.1 ? 0 : r, u = Math.max(d && h, 0), g = Math.max(c && p, 0), f = [
                t + d,
                e
            ], m = [
                t + i - d,
                ...
                t,
                e + d
            ], L = (t, e)=>Math.sqrt(Math.pow(t, 2) - Math.pow(e, 2));
            if (u) {
                let t = L(d, d - u);
                f[0] -= t, m[0] += t, b[1] = v[1] = e + d - u;
            }
            if (s < d - u) {
                let a = L(d, d - u - s);
                b[0] = y[0] = t + i - d + a, x[0] = Math.min(b[0], x[0]), P[0] = Math.max(y[0], P[0]), M[0] = v[0] = t + d - a, b[1] = v[1] = e + s;
            }
            if (g) {
                let t = L(c, c - g);
                x[0] += t, P[0] -= t, y[1] = M[1] = e + s - c + g;
            }
            if (s < c - g) {
                let a = L(c, c - g - s);
                b[0] = y[0] = t + i - c + a, m[0] = Math.min(b[0], m[0]), f[0] = Math.max(y[0], f[0]), M[0] = v[0] = t + c - a, y[1] = M[1] = e;
            }
        ...
        }, { defaultOptions: sg } = x(), { composed: sf, noop: sm } = x(), { addEvent: sb, correctFloat: sy, defined: sx, extend: sP, fireEvent: sM, isObject: sv, merge: sL, pick: sk, pushUnique: sw, relativeLength: sA, splat: sS, wrap: sT } = x();
        !function(t) {
            function e() {
            ...
            function i() {
                return ()=>{
                    if (this.isRadial && this.tickPositions && this.options.labels && !0 !== this.options.labels.allowOverlap) return this.tickPositions.map((t)=>this.ticks[t]?.label).filter((t)=>!!t);
                };
            }
            function s() {
                return sm;
            ...
            function a(t, e, i) {
                let s = this.pane.center, a = t.value, o, r, n;
                return this.isCircular ? (sx(a) ? t.point && (t.point.shapeArgs || {}).start && (a = this.chart.inverted ? this.translate(t.point.rectPlotY, !0) : t.point.x) : (r = t.chartX || 0, n = t.chartY || 0, a = this.translate(Math.atan2(n - i, r - e) - this.startAngleRad, !0)), r = (o = this.getPosition(a)).x, n = o.y) : (sx(a) || (r = t.chartX, n = t.chartY), sx(r) && sx(n) && (i = s[1] + this.chart.plotTop, a = this.translate(Math.min(Math.sqrt(Math.pow(r - e, 2) + Math.pow(n - i, 2)), s[2] / 2) - s[3] / 2, !0))), [
                    a,
                    r || 0,
                    n || 0
                ];
            ...
            function o(t, e, i) {
                let s = this.pane.center, a = this.chart, o = this.left || 0, r = this.top || 0, n, l = sk(e, s[2] / 2 - this.offset), h;
                return void 0 === i && (i = this.horiz ? 0 : this.center && -this.center[3] / 2), i && (l += i), this.isCircular || void 0 !== e ? ((h = this.chart.renderer.symbols.arc(o + s[0], r + s[1], l, l, {
                    ...
                    r + s[1] - l
                ]) : (n = this.postTranslate(this.angleRad, l), h = [
                    [
                        "M",
                        this.center[0] + a.plotLeft,
                        this.center[1] + a.plotTop
                    ],
                    [
                        "L",
                        n.x,
            ...
            function n(t, e, i) {
                let s = this.chart, a = (t)=>{
                    if ("string" == typeof t) {
                        let e = parseInt(t, 10);
                        return c.test(t) && (e = e * l / 100), e;
                    }
                    return t;
                }, o = this.center, r = this.startAngleRad, n = i.borderRadius, l = o[2] / 2, h = Math.min(this.offset, 0), p = this.left || 0, d = this.top || 0, c = /%$/, u = this.isCircular, g = this.options.plotBands || [], f = g.indexOf(i), m, b, y, x, P, M, v = sk(a(i.outerRadius), l), L = a(i.innerRadius), k = sk(a(i.thickness), 10), w = !0, A = !0;
                if (n && f > -1 && (g[f - 1] && g[f - 1].to === t && (w = !1), g[f + 1] && g[f + 1].from === e && (A = !1)), "polygon" === this.options.gridLineInterpolation) M = this.getPlotLinePath({
                    value: t
                    ...
                    let a = this.translate(t), l = this.translate(e);
                    u || (v = a || 0, L = l || 0), "circle" !== i.shape && u ? (m = r + (a || 0), b = r + (l || 0)) : (m = -Math.PI / 2, b = 1.5 * Math.PI, P = !0), v -= h, k -= h, M = s.renderer.symbols.arc(p + o[0], d + o[1], v, v, {
                        start: Math.min(m, b),
                        end: Math.max(m, b),
                        innerR: sk(L, v - k),
                        open: P,
                        ...
                        brStart: w,
                        brEnd: A
                    }), u && (y = (b + m) / 2, x = p + o[0] + o[2] / 2 * Math.cos(y), M.xBounds = y > -Math.PI / 2 && y < Math.PI / 2 ? [
                        x,
                        s.plotWidth
                    ] : [
                        0,
                        ...
                        d + o[1] + o[2] / 2 * Math.sin(y)
                    ], M.yBounds[0] += y > -Math.PI && y < 0 || y > Math.PI ? -10 : 10);
                }
                return M;
            }
            function l(t) {
                let e = this.pane.center, i = this.chart, s = i.inverted, a = t.reverse, o = this.pane.options.background, r = o ? sS(o)[0] : {}, n = r.innerRadius || "0%", l = r.outerRadius || "100%", h = e[0] + i.plotLeft, p = e[1] + i.plotTop, d = this.height, c = t.isCrosshair, u = e[3] / 2, g = t.value, f, m, b, y, x, P, M, v, L, k = this.getPosition(g), w = k.x, A = k.y;
                if (c && (g = (v = this.getCrosshairPosition(t, h, p))[0], w = v[1], A = v[2]), this.isCircular) m = Math.sqrt(Math.pow(w - h, 2) + Math.pow(A - p, 2)), b = "string" == typeof n ? sA(n, 1) : n / m, y = "string" == typeof l ? sA(l, 1) : l / m, e && u && (b < (f = u / m) && (b = f), y < f && (y = f)), L = [
                    [
                        "M",
                        h + b * (w - h),
                        p - b * (p - A)
                ...
                else if ((g = this.translate(g)) && (g < 0 || g > d) && (g = 0), "circle" === this.options.gridLineInterpolation) L = this.getLinePath(0, g, u);
                else if (L = [], i[s ? "yAxis" : "xAxis"].forEach((t)=>{
                    t.pane === this.pane && (x = t);
                }), x) {
                    M = x.tickPositions, x.autoConnect && (M = M.concat([
                        M[0]
                    ])), a && (M = M.slice().reverse()), g && (g += u);
                    for(let t = 0; t < M.length; t++)P = x.getPosition(M[t], g), L.push(t ? [
                        "L",
                        P.x,
                        P.y
                    ] : [
            ...
            function h(t, e) {
                ...
                return this.postTranslate(this.isCircular ? i : this.angleRad, sk(this.isCircular ? e : i < 0 ? 0 : i, this.center[2] / 2) - this.offset);
            }
            function p() {
                let t = this.center, e = this.chart, i = this.options.title;
                return {
            ...
            function d(t) {
                t.beforeSetTickPositions = e, t.createLabelCollector = i, t.getCrosshairPosition = a, t.getLinePath = o, t.getOffset = r, t.getPlotBandPath = n, t.getPlotLinePath = l, t.getPosition = h, t.getTitlePosition = p, t.postTranslate = M, t.setAxisSize = L, t.setAxisTranslation = k, t.setOptions = w;
            }
            function c() {
                let t = this.chart, e = this.options, i = t.angular && this.isXAxis, s = this.pane, a = s?.options;
                if (!i && s && (t.angular || t.polar)) {
                    let t = 2 * Math.PI, i = (sk(a.startAngle, 0) - 90) * Math.PI / 180, s = (sk(a.endAngle, sk(a.startAngle, 0) + 360) - 90) * Math.PI / 180;
                    this.angleRad = (e.angle || 0) * Math.PI / 180, this.startAngleRad = i, this.endAngleRad = s, this.offset = e.offset || 0;
                    let o = (i % t + t) % t, r = (s % t + t) % t;
                    o > Math.PI && (o -= t), r > Math.PI && (r -= t), this.normalizedStartAngleRad = o, this.normalizedEndAngleRad = r;
                }
            }
            function u(t) {
            ...
            function f(t) {
                let e, i = this.chart, a = i.angular, o = i.polar, r = this.isXAxis, n = this.coll, l = t.userOptions.pane || 0, h = this.pane = i.pane && i.pane[l];
                if ("colorAxis" === n) {
                    this.isRadial = !1;
                    return;
                }
                if (a) {
                    if (a && r) this.isHidden = !0, this.createLabelCollector = s, this.getOffset = sm, this.redraw = v, this.render = v, this.setScale = sm, this.setCategories = sm, this.setTitle = sm;
                    else d(this);
                    e = !r;
                } else o && (d(this), e = this.horiz);
                a || o ? (this.isRadial = !0, this.labelCollector || (this.labelCollector = this.createLabelCollector()), this.labelCollector && i.labelCollectors.push(this.labelCollector)) : this.isRadial = !1, h && e && (h.axis = this), this.isCircular = e;
            }
            function m() {
            ...
            function b(t) {
                let e = this.label;
                if (!e) return;
                let i = this.axis, s = e.getBBox(), a = i.options.labels, o = (i.translate(this.pos) + i.startAngleRad + Math.PI / 2) / Math.PI * 180 % 360, r = Math.round(o), n = sx(a.y) ? 0 : -(.3 * s.height), l = a.y, h, p = 20, d = a.align, c = "end", u = r < 0 ? r + 360 : r, g = u, f = 0, m = 0;
                i.isRadial && (h = i.getPosition(this.pos, i.center[2] / 2 + sA(sk(a.distance, -25), i.center[2] / 2, -i.center[2] / 2)), "auto" === a.rotation ? e.attr({
                    rotation: o
                }) : sx(l) || (l = i.chart.renderer.fontMetrics(e).b - s.height / 2), sx(d) || (i.isCircular ? (s.width > i.len * i.tickInterval / (i.max - i.min) && (p = 0), d = o > p && o < 180 - p ? "left" : o > 180 + p && o < 360 - p ? "right" : "center") : d = "center", e.attr({
                    align: d
                })), "auto" === d && 2 === i.tickPositions.length && i.isCircular && (u > 90 && u < 180 ? u = 180 - u : u > 270 && u <= 360 && (u = 540 - u), g > 180 && g <= 360 && (g = 360 - g), (i.pane.options.startAngle === r || i.pane.options.startAngle === r + 360 || i.pane.options.startAngle === r - 360) && (c = "start"), d = r >= -90 && r <= 90 || r >= -360 && r <= -270 || r >= 270 && r <= 360 ? "start" === c ? "right" : "left" : "start" === c ? "left" : "right", g > 70 && g < 110 && (d = "center"), u < 15 || u >= 180 && u < 195 ? f = .3 * s.height : u >= 15 && u <= 35 ? f = "start" === c ? 0 : .75 * s.height : u >= 195 && u <= 215 ? f = "start" === c ? .75 * s.height : 0 : u > 35 && u <= 90 ? f = "start" === c ? -(.25 * s.height) : s.height : u > 215 && u <= 270 && (f = "start" === c ? s.height : -(.25 * s.height)), g < 15 ? m = "start" === c ? -(.15 * s.height) : .15 * s.height : g > 165 && g <= 180 && (m = "start" === c ? .15 * s.height : -(.15 * s.height)), e.attr({
                    align: d
                }), e.translate(m, f + n)), t.pos.x = h.x + (a.x || 0), t.pos.y = h.y + (l || 0));
            }
            function y(t) {
                this.axis.getPosition && sP(t.pos, this.axis.getPosition(this.pos));
            }
            function P({ options: e }) {
                e.xAxis && sL(!0, t.radialDefaultOptions.circular, e.xAxis), e.yAxis && sL(!0, t.radialDefaultOptions.radialGauge, e.yAxis);
            }
            function M(t, e) {
                let i = this.chart, s = this.center;
            ...
            function w(e) {
                let { coll: i } = this, { angular: s, inverted: a, polar: o } = this.chart, r = {};
                s ? this.isXAxis || (r = sL(sg.yAxis, t.radialDefaultOptions.radialGauge)) : o && (r = this.horiz ? sL(sg.xAxis, t.radialDefaultOptions.circular) : sL("xAxis" === i ? sg.xAxis : sg.yAxis, t.radialDefaultOptions.radial)), a && "yAxis" === i && (r.stackLabels = sv(sg.yAxis, !0) ? sg.yAxis.stackLabels : {}, r.reversedStacks = !0);
                let n = this.options = sL(r, e);
                n.plotBands || (n.plotBands = []), sM(this, "afterSetOptions");
            }
            function A(t, e, i, s, a, o, r) {
                let n, l = this.axis;
                return l.isRadial ? [
                    "M",
                    e,
                    ...
                    n.y
                ] : t.call(this, e, i, s, a, o, r);
            }
            t.radialDefaultOptions = sL(su), t.compose = function(t, e) {
                return sw(sf, "Axis.Radial") && (sb(t, "afterInit", c), sb(t, "autoLabelAlign", u), sb(t, "destroy", g), sb(t, "init", f), sb(t, "initialAxisTranslation", m), sb(e, "afterGetLabelPosition", b), sb(e, "afterGetPosition", y), sb(x(), "setOptions", P), sT(e.prototype, "getMarkPath", A)), t;
            };
        }(c || (c = {}));
        let sC = c, { animObject: sN } = x(), { optionsToObject: sX } = {
            compose: function(t, e, i) {
                let s = t.types.pie;
                if (!e.symbolCustomAttribs.includes("borderRadius")) {
                    let a = i.prototype.symbols;
                    st(t, "afterColumnTranslate", sh, {
                        order: 9
                    }), st(s, "afterTranslate", sd), e.symbolCustomAttribs.push("borderRadius", "brBoxHeight", "brBoxY", "brEnd", "brStart"), sr = a.arc, sn = a.roundedRect, a.arc = sl, a.roundedRect = sc;
                }
            },
            optionsToObject: sp
        }, { defaultOptions: sY } = x(), { composed: sR } = x(), { addEvent: sI, defined: sE, find: sD, isNumber: sz, isObject: sO, merge: sH, pick: sB, pushUnique: sW, relativeLength: sF, splat: sG, uniqueKey: sq, wrap: sV } = x();
        function s_() {
            (this.pane || []).forEach((t)=>{
                t.render();
            });
        ...
        function sU(t) {
            let e = t.args[0].xAxis, i = t.args[0].yAxis, s = t.args[0].chart;
        ...
        function sK() {
            this.pane || (this.pane = []), this.options.pane = sG(this.options.pane || {}), sG(this.userOptions.pane || {}).forEach((t)=>{
                new _(t, this);
            }, this);
        }
        function sj(t) {
            let e = t.args.marker, i = this.chart.xAxis[0], s = this.chart.yAxis[0], a = this.chart.inverted, o = a ? s : i, r = a ? i : s;
            if (this.chart.polar) {
                t.preventDefault();
                let i = (e.attr ? e.attr("start") : e.start) - o.startAngleRad, s = e.attr ? e.attr("r") : e.r, a = (e.attr ? e.attr("end") : e.end) - o.startAngleRad, n = e.attr ? e.attr("innerR") : e.innerR;
                t.result.x = i + o.pos, t.result.width = a - i, t.result.y = r.len + r.pos - s, t.result.height = s - n;
            }
        }
        function sZ(t) {
            let e = this.chart;
            if (e.polar && e.hoverPane && e.hoverPane.axis) {
                t.preventDefault();
                let i = e.hoverPane.center, s = e.mouseDownX || 0, a = e.mouseDownY || 0, o = t.args.chartY, r = t.args.chartX, n = 2 * Math.PI, l = e.hoverPane.axis.startAngleRad, h = e.hoverPane.axis.endAngleRad, p = e.inverted ? e.xAxis[0] : e.yAxis[0], d = {}, c = "arc";
                if (d.x = i[0] + e.plotLeft, d.y = i[1] + e.plotTop, this.zoomHor) {
                    let t = l > 0 ? h - l : Math.abs(l) + Math.abs(h), u = Math.atan2(a - e.plotTop - i[1], s - e.plotLeft - i[0]) - l, g = Math.atan2(o - e.plotTop - i[1], r - e.plotLeft - i[0]) - l;
                    d.r = i[2] / 2, d.innerR = i[3] / 2, u <= 0 && (u += n), g <= 0 && (g += n), g < u && (g = [
                        u,
                        u = g
                    ][0]), t < n && l + g > h + (n - t) / 2 && (g = u, u = l <= 0 ? l : 0);
                    let f = d.start = Math.max(u + l, l), m = d.end = Math.min(g + l, h);
                    if ("polygon" === p.options.gridLineInterpolation) {
                        let t = e.hoverPane.axis, s = f - t.startAngleRad + t.pos, a = p.getPlotLinePath({
                            value: p.max
                        }), o = t.toValue(s), r = t.toValue(s + (m - f));
                        if (o < t.getExtremes().min) {
                ...
                if (this.zoomVert) {
                    let t = e.inverted ? e.xAxis[0] : e.yAxis[0], n = Math.sqrt(Math.pow(s - e.plotLeft - i[0], 2) + Math.pow(a - e.plotTop - i[1], 2)), p = Math.sqrt(Math.pow(r - e.plotLeft - i[0], 2) + Math.pow(o - e.plotTop - i[1], 2));
                    if (p < n && (n = [
                        p,
                        p = n
                    ][0]), p > i[2] / 2 && (p = i[2] / 2), n < i[3] / 2 && (n = i[3] / 2), this.zoomHor || (d.start = l, d.end = h), d.r = p, d.innerR = n, "polygon" === t.options.gridLineInterpolation) {
                        let e = t.toValue(t.len + t.pos - n), i = t.toValue(t.len + t.pos - p);
                        d.d = t.getPlotLinePath({
                            value: i
                ...
                if (this.zoomHor && this.zoomVert && "polygon" === p.options.gridLineInterpolation) {
                    let t = e.hoverPane.axis, i = d.start || 0, s = d.end || 0, a = i - t.startAngleRad + t.pos, o = t.toValue(a), r = t.toValue(a + (s - i));
                    if (d.d instanceof Array) {
                        let t = d.d.slice(0, d.d.length / 2), i = d.d.slice(d.d.length / 2, d.d.length);
                        i = [
                            ...i
                        ].reverse();
                        let s = e.hoverPane.axis;
                        t = s1(t, o, r, s), (i = s1(i, o, r, s)) && (i[0][0] = "L"), i = [
                            ...i
                        ].reverse(), d.d = t.concat(i), c = "path";
                    }
                }
        ...
        function s$() {
            let t = this.chart;
            t.polar && (this.polar = new ae(this), t.inverted && (this.isRadialSeries = !0, this.is("column") && (this.isRadialBar = !0)));
        }
        function sQ() {
            let { chart: t, options: e, yAxis: i } = this;
            if (e.borderRadius && t.polar && t.inverted) {
                let t = sY.plotOptions?.[this.type]?.borderRadius, { scope: s, where: a = "end" } = sX(e.borderRadius, sO(t) ? t : {});
                for (let t of this.points){
                    let { shapeArgs: o } = t;
                    if ("arc" === t.shapeType && o) {
                        let r = "all" === a, n = !0;
                        e.stacking && "stack" === s && (r = t.stackY === t.y && "all" === a, n = t.stackY === t.stackTotal), i.reversed && ([r, n] = [
                            n,
                            r
                        ]), o.brStart = r, o.brEnd = n;
                    }
                }
            }
        }
        function sJ() {
            if (this.chart.polar && this.xAxis) {
                let { xAxis: t, yAxis: e } = this, i = this.chart;
                this.kdByAngle = i.tooltip && i.tooltip.shared, this.kdByAngle || i.inverted ? this.searchPoint = s0 : this.options.findNearestPointBy = "xy";
                let s = this.points, a = s.length;
                for(; a--;)this.is("column") || this.is("columnrange") || this.polar.toXY(s[a]), i.hasParallelCoordinates || this.yAxis.reversed || (sB(s[a].y, 5e-324) < e.min || s[a].x < t.min || s[a].x > t.max ? (s[a].isNull = !0, s[a].plotY = NaN) : s[a].isNull = s[a].isValid && !s[a].isValid());
                this.hasClipCircleSetter || (this.hasClipCircleSetter = !!this.eventsToUnbind.push(sI(this, "afterRender", function() {
                    let t;
                    if (i.polar && !1 !== this.options.clip) {
                        if (t = this.yAxis.pane.center, this.clipCircle) this.clipCircle.animate({
                            x: t[0],
                            y: t[1],
                            r: t[2] / 2,
                            innerR: t[3] / 2
                            ...
                            var e, s, a, o, r;
                            let n, l, h;
                            this.clipCircle = (e = i.renderer, s = t[0], a = t[1], o = t[2] / 2, r = t[3] / 2, n = sq(), l = e.createElement("clipPath").attr({
                                id: n
                            }).add(e.defs), (h = r ? e.arc(s, a, o, r, 0, 2 * Math.PI).add(l) : e.circle(s, a, o).add(l)).id = n, h.clipPath = l, h);
                        }
        ...
        function s0(t) {
            let e = this.chart, i = this.xAxis, s = this.yAxis, a = i.pane && i.pane.center, o = t.chartX - (a && a[0] || 0) - e.plotLeft, r = t.chartY - (a && a[1] || 0) - e.plotTop, n = e.inverted ? {
                ...
                clientX: 180 + -180 / Math.PI * Math.atan2(o, r)
            };
            return this.searchKDTree(n);
        }
        function s1(t, e, i, s) {
            let a = s.tickInterval, o = s.tickPositions, r = sD(o, (t)=>t >= i), n = sD([
                ...o
            ].reverse(), (t)=>t <= e);
            return sE(r) || (r = o[o.length - 1]), sE(n) || (n = o[0], r += a, t[0][0] = "L", t.unshift(t[t.length - 3])), (t = t.slice(o.indexOf(n), o.indexOf(r) + 1))[0][0] = "M", t;
        }
        function s2(t, e) {
            return sD(this.pane || [], (t)=>t.options.id === e) || t.call(this, e);
        }
        function s3(t, e, i, s, a, o) {
            let r, n, l, h = this.chart, p = sB(s.inside, !!this.options.stacking);
            if (h.polar) {
                if (r = e.rectPlotX / Math.PI * 180, h.inverted) this.forceDL = h.isInsidePlot(e.plotX, e.plotY), p && e.shapeArgs ? (n = e.shapeArgs, a = sH(a, {
                    x: (l = this.yAxis.postTranslate(((n.start || 0) + (n.end || 0)) / 2 - this.xAxis.startAngleRad, e.barX + e.pointWidth / 2)).x - h.plotLeft,
                    y: l.y - h.plotTop
                })) : e.tooltipPos && (a = sH(a, {
                    x: e.tooltipPos[0],
                    y: e.tooltipPos[1]
                })), s.align = sB(s.align, "center"), s.verticalAlign = sB(s.verticalAlign, "middle");
                else {
                    var d;
                    null === (d = s).align && (d.align = r > 20 && r < 160 ? "left" : r > 200 && r < 340 ? "right" : "center"), null === d.verticalAlign && (d.verticalAlign = r < 45 || r > 315 ? "bottom" : r > 135 && r < 225 ? "top" : "middle"), s = d;
                }
                L().prototype.alignDataLabel.call(this, e, i, s, a, o), this.isRadialBar && e.shapeArgs && e.shapeArgs.start === e.shapeArgs.end ? i.hide() : i.show();
            } else t.call(this, e, i, s, a, o);
        }
        function s5() {
            let t = this.options, e = t.stacking, i = this.chart, s = this.xAxis, a = this.yAxis, o = a.reversed, r = a.center, n = s.startAngleRad, l = s.endAngleRad - n, h = t.threshold, p = 0, d, c, u, g, f, m = 0, b = 0, y, P, M, v, L, k, w, A;
            if (s.isRadial) for(u = (d = this.points).length, g = a.translate(a.min), f = a.translate(a.max), h = t.threshold || 0, i.inverted && sz(h) && sE(p = a.translate(h)) && (p < 0 ? p = 0 : p > l && (p = l), this.translatedThreshold = p + n); u--;){
                if (k = (c = d[u]).barX, P = c.x, M = c.y, c.shapeType = "arc", i.inverted) {
                    c.plotY = a.translate(M), e && a.stacking ? (L = a.stacking.stacks[(M < 0 ? "-" : "") + this.stackKey], this.visible && L && L[P] && !c.isNull && (v = L[P].points[this.getStackIndicator(void 0, P, this.index).key], m = a.translate(v[0]), b = a.translate(v[1]), sE(m) && (m = x().clamp(m, 0, l)))) : (m = p, b = c.plotY), m > b && (b = [
                        m,
                        m = b
                    ][0]), o ? b > g ? b = g : m < f ? m = f : (m > g || b < f) && (m = b = l) : m < g ? m = g : b > f ? b = f : (b < g || m > f) && (m = b = 0), a.min > a.max && (m = b = o ? l : 0), m += n, b += n, r && (c.barX = k += r[3] / 2), w = Math.max(k, 0), A = Math.max(k + c.pointWidth, 0);
                    let i = t.borderRadius, s = sF(("object" == typeof i ? i.radius : i) || 0, A - w);
                    c.shapeArgs = {
                        x: r[0],
                        y: r[1],
                        r: A,
                        ...
                        borderRadius: s
                    }, c.opacity = m === b ? 0 : void 0, c.plotY = (sE(this.translatedThreshold) && (m < this.translatedThreshold ? m : b)) - n;
                } else m = k + n, c.shapeArgs = this.polar.arc(c.yBottom, c.plotY, m, m + c.pointWidth), c.shapeArgs.borderRadius = 0;
                this.polar.toXY(c), i.inverted ? (y = a.postTranslate(c.rectPlotY, k + c.pointWidth / 2), c.tooltipPos = [
                    y.x - i.plotLeft,
                    y.y - i.plotTop
                ]) : c.tooltipPos = [
                    c.plotX,
        ...
        function s8(t, e) {
            ...
            if (this.chart.polar) {
                ...
                !1 !== this.options.connectEnds && void 0 !== i && (this.connectEnds = !0, e.splice(e.length, 0, e[i]), s = !0), e.forEach((t)=>{
                    void 0 === t.polarPlotY && a.polar.toXY(t);
                });
            }
            let o = t.apply(this, [].slice.call(arguments, 1));
            return s && e.pop(), o;
        }
        function s6(t, e) {
            let i = this.chart, s = {
            ...
            return i.polar ? i.axes.forEach((t)=>{
                ...
                let a = t.isXAxis, o = t.center, r = e.chartX - o[0] - i.plotLeft, n = e.chartY - o[1] - i.plotTop;
                s[a ? "xAxis" : "yAxis"].push({
                    axis: t,
                    value: t.translate(a ? Math.PI - Math.atan2(r, n) : Math.sqrt(Math.pow(r, 2) + Math.pow(n, 2)), !0)
                });
            }) : s = t.call(this, e), s;
        }
        function s4(t, e) {
        ...
        function s9(t, e) {
            let i = this, s = this.chart, a = this.group, o = this.markerGroup, r = this.xAxis && this.xAxis.center, n = s.plotLeft, l = s.plotTop, h = this.options.animation, p, d, c, u, g, f;
            s.polar ? i.isRadialBar ? e || (i.startAngleRad = sB(i.translatedThreshold, i.xAxis.startAngleRad), x().seriesTypes.pie.prototype.animate.call(i, e)) : (h = sN(h), i.is("column") ? e || (d = r[3] / 2, i.points.forEach((t)=>{
                c = t.graphic, g = (u = t.shapeArgs) && u.r, f = u && u.innerR, c && u && (c.attr({
                    r: d,
                    innerR: d
                }), c.animate({
                    r: g,
                ...
                scaleX: .001,
                scaleY: .001
            }, a.attr(p), o && o.attr(p)) : (p = {
                translateX: n,
                translateY: l,
                scaleX: 1,
                scaleY: 1
            }, a.animate(p, h), o && o.animate(p, h))) : t.call(this, e);
        }
        function s7(t, e, i, s) {
            let a, o;
            if (this.chart.polar) if (s) {
                let t = (o = function t(e, i, s, a) {
                    let o, r, n, l, h, p, d = +!!a, c = (o = i >= 0 && i <= e.length - 1 ? i : i < 0 ? e.length - 1 + i : 0) - 1 < 0 ? e.length - (1 + d) : o - 1, u = o + 1 > e.length - 1 ? d : o + 1, g = e[c], f = e[u], m = g.plotX, b = g.plotY, y = f.plotX, x = f.plotY, P = e[o].plotX, M = e[o].plotY;
                    r = (1.5 * P + m) / 2.5, n = (1.5 * M + b) / 2.5, l = (1.5 * P + y) / 2.5, h = (1.5 * M + x) / 2.5;
                    let v = Math.sqrt(Math.pow(r - P, 2) + Math.pow(n - M, 2)), L = Math.sqrt(Math.pow(l - P, 2) + Math.pow(h - M, 2)), k = Math.atan2(n - M, r - P);
                    p = Math.PI / 2 + (k + Math.atan2(h - M, l - P)) / 2, Math.abs(k - p) > Math.PI / 2 && (p -= Math.PI), r = P + Math.cos(p) * v, n = M + Math.sin(p) * v;
                    let w = {
                        rightContX: l = P + Math.cos(Math.PI + p) * L,
                        rightContY: h = M + Math.sin(Math.PI + p) * L,
                        leftContX: r,
                        leftContY: n,
                        plotX: P,
                        plotY: M
                    };
                    return s && (w.prevPointCont = t(e, c, !1, a)), w;
                }(e, s, !0, this.connectEnds)).prevPointCont && o.prevPointCont.rightContX, i = o.prevPointCont && o.prevPointCont.rightContY;
                a = [
                    "C",
                    sz(t) ? t : o.plotX,
                    sz(i) ? i : o.plotY,
                    sz(o.leftContX) ? o.leftContX : o.plotX,
                    sz(o.leftContY) ? o.leftContY : o.plotY,
                    o.plotX,
                    o.plotY
                ];
            } else a = [
            ...
            else a = t.call(this, e, i, s);
            return a;
        }
        function at(t, e, i = this.plotY) {
            if (!this.destroyed) {
                let { plotX: s, series: a } = this, { chart: o } = a;
                return o.polar && sz(s) && sz(i) ? [
                    s + (e ? o.plotLeft : 0),
                    i + (e ? o.plotTop : 0)
                ] : t.call(this, e, i);
            }
        ...
        class ae {
            static compose(t, e, i, s, a, o, r, n, l, h) {
                if (_.compose(e, i, s), sC.compose(t, a), sW(sR, "Polar")) {
                    let t = e.prototype, a = o.prototype, p = i.prototype, d = s.prototype;
                    if (sI(e, "afterDrawChartBox", s_), sI(e, "createAxes", sK), sI(e, "init", sU), sV(t, "get", s2), sV(p, "getCoordinates", s6), sV(p, "pinch", s4), sI(i, "getSelectionMarkerAttrs", sZ), sI(i, "getSelectionBox", sj), sI(s, "afterInit", s$), sI(s, "afterColumnTranslate", sQ, {
                        order: 9
                    }), sI(s, "afterTranslate", sJ, {
                        order: 2
                    }), sI(s, "afterColumnTranslate", s5, {
                        order: 4
                    }), sV(d, "animate", s9), sV(a, "pos", at), n) {
                        let t = n.prototype;
                        sV(t, "alignDataLabel", s3), sV(t, "animate", s9);
                    }
                    if (l && sV(l.prototype, "getGraphPath", s8), h) {
                        let t = h.prototype;
                        sV(t, "getPointSpline", s7), r && (r.prototype.getPointSpline = t.getPointSpline);
                    }
                }
            }
            constructor(t){
            ...
            arc(t, e, i, s) {
                let a = this.series, o = a.xAxis.center, r = a.yAxis.len, n = o[3] / 2, l = r - e + n, h = r - sB(t, r) + n;
                return a.yAxis.reversed && (l < 0 && (l = n), h < 0 && (h = n)), {
                    x: o[0],
                    y: o[1],
                    r: l,
                    innerR: h,
            ...
            toXY(t) {
                let e = this.series, i = e.chart, s = e.xAxis, a = e.yAxis, o = t.plotX, r = i.inverted, n = t.y, l = t.plotY, h = r ? o : a.len - l, p;
                if (r && e && !e.isRadialBar && (t.plotY = l = sz(n) ? a.translate(n) : 0), t.rectPlotX = o, t.rectPlotY = l, a.center && (h += a.center[3] / 2), sz(l)) {
                    let e = r ? a.postTranslate(l, h) : s.postTranslate(o, h);
                    t.plotX = t.polarPlotX = e.x - i.plotLeft, t.plotY = t.polarPlotY = e.y - i.plotTop;
                }
                e.kdByAngle ? ((p = (o / Math.PI * 180 + s.pane.options.startAngle) % 360) < 0 && (p += 360), t.clientX = p) : t.clientX = t.plotX;
            }
        }
        ...
        !function(t) {
            ...
            function i() {
                ...
                t?.enabled && this.waterfall?.stacks && this.waterfall.renderStackTotals();
            }
            function s() {
            ...
            function a() {
                ...
                for (let e of this.series)if (e.options.stacking) {
                    for (let e of t)!e.isXAxis && e.waterfall && (e.waterfall.stacks.changed = !0);
                    break;
                }
            }
            t.compose = function(t, o) {
                an(aa, "Axis.Waterfall") && (ao(t, "init", s), ao(t, "afterBuildStacks", e), ao(t, "afterRender", i), ao(o, "beforeRedraw", a));
            };
            class o {
                constructor(t){
                ...
                renderStackTotals() {
                    let t = this.axis, e = t.waterfall?.stacks, i = t.stacking?.stackTotalGroup, s = new (as())(t, t.options.stackLabels || {}, !1, 0, void 0);
                    this.dummyStackItem = s, i && ar(e, (t)=>{
                        ar(t, (t, e)=>{
                            s.total = t.stackTotal, s.x = +e, t.label && (s.label = t.label), as().prototype.render.call(s, i), t.label = s.label, delete s.label;
                        });
                    }), s.total = null;
                }
            }
        ...
        class ap extends tm().prototype.pointClass {
            getClassName() {
                let t = tZ().prototype.getClassName.call(this);
        ...
        class ak extends ad {
            generatePoints() {
                ...
                for(let e = 0, i = this.points.length; e < i; e++){
                    let i = this.points[e], s = t[e];
                    ax(s) && (i.isIntermediateSum || i.isSum) && (i.y = am(s));
                }
            }
            processData(t) {
                let e, i, s, a, o, r, n = this.options, l = this.getColumn("y"), h = n.data, p = l.length, d = n.threshold || 0;
                s = i = a = o = 0;
                for(let t = 0; t < p; t++)r = l[t], e = h?.[t] || {}, "sum" === r || e.isSum ? l[t] = am(s) : "intermediateSum" === r || e.isIntermediateSum ? (l[t] = am(i), i = 0) : (s += r, i += r), a = Math.min(s, a), o = Math.max(s, o);
                super.processData.call(this, t), n.stacking || (this.dataMin = a + d, this.dataMax = o);
            }
            toYData(t) {
            ...
            pointAttribs(t, e) {
                ...
                i && !t.options.color && ax(t.y) && (t.color = t.y > 0 ? i : void 0);
                let s = ad.prototype.pointAttribs.call(this, t, e);
            ...
            getCrispPath() {
                let t = this.points.filter((t)=>ax(t.y)), e = this.yAxis, i = t.length, s = this.graph?.strokeWidth() || 0, a = this.xAxis.reversed, o = this.yAxis.reversed, r = this.options.stacking, n = [];
                for(let l = 1; l < i; l++){
                    if (!(this.options.connectNulls || ax(this.data[t[l].index - 1].y))) continue;
                    let i = t[l].box, h = t[l - 1], p = h.y || 0, d = t[l - 1].box;
                    if (!i || !d) continue;
                    let c = e.waterfall?.stacks[this.stackKey], u = p > 0 ? -d.height : 0;
                    if (c && d && i) {
                        let t, p = c[l - 1];
                        t = r ? ab(e.translate(p.connectorThreshold || 0, !1, !0, !1, !0) + (o ? u : 0), s) : ab(d.y + (h.minPointLengthOffset || 0), s), n.push([
                            "M",
                            (d.x || 0) + (a ? 0 : d.width || 0),
                            t
                        ], [
                    ...
                    if (d && n.length && (!r && p < 0 && !o || p > 0 && o)) {
                        let t = n[n.length - 2];
                        t && "number" == typeof t[2] && (t[2] += d.height || 0);
                        let e = n[n.length - 1];
                        e && "number" == typeof e[2] && (e[2] += d.height || 0);
                    }
                }
                return n;
            }
            drawGraph() {
                ac.prototype.drawGraph.call(this), this.graph?.animate({
                    d: this.getCrispPath()
                });
            }
            setStackedPoints(t) {
                let e = this.options, i = t.waterfall?.stacks, s = e.threshold || 0, a = this.stackKey, o = this.getColumn("x"), r = this.getColumn("y"), n = o.length, l = s, h = l, p, d = 0, c = 0, u = 0, g, f, m, b, y, x, P, M, v = (t, e, i, s)=>{
                    if (p) {
                        if (g) for(; i < g; i++)p.stackState[i] += s;
                        else p.stackState[0] = t, g = p.stackState.length;
                        p.stackState.push(p.stackState[g - 1] + e);
                    }
                };
                if (t.stacking && i && this.reserveSpace()) {
                    M = i.changed, (P = i.alreadyChanged) && 0 > P.indexOf(a) && (M = !0), i[a] || (i[a] = {});
                    let t = i[a];
                    if (t) for(let i = 0; i < n; i++)(!t[x = o[i]] || M) && (t[x] = {
                        negTotal: 0,
                        posTotal: 0,
                        stackTotal: 0,
                        threshold: 0,
                        stateIndex: 0,
                        stackState: [],
                        label: M && t[x] ? t[x].label : void 0
                    }), p = t[x], (y = r[i]) >= 0 ? p.posTotal += y : p.negTotal += y, b = e.data[i], f = p.absolutePos = p.posTotal, m = p.absoluteNeg = p.negTotal, p.stackTotal = f + m, g = p.stackState.length, b?.isIntermediateSum ? (v(u, c, 0, u), u = c, c = s, l ^= h, h ^= l, l ^= h) : b?.isSum ? (v(s, d, g, 0), l = s) : (v(l, y, 0, d), b && (d += y, c += y)), p.stateIndex++, p.threshold = l, l += p.stackTotal;
                    i.changed = !1, i.alreadyChanged || (i.alreadyChanged = []), i.alreadyChanged.push(a);
                }
            }
            getExtremes() {
                let t, e, i = this.options.stacking, s = this.yAxis, a = s.waterfall?.stacks;
                return i && a ? (t = this.stackedYNeg = [], e = this.stackedYPos = [], "overlap" === i ? aM(a[this.stackKey], function(i) {
                    t.push(af(i.stackState)), e.push(ag(i.stackState));
                }) : aM(a[this.stackKey], function(i) {
                    t.push(i.negTotal + i.threshold), e.push(i.posTotal + i.threshold);
                }), {
                    dataMin: af(t),
                    dataMax: ag(e)
                }) : {
        ...
        ak.defaultOptions = aP(ad.defaultOptions, {
            dataLabels: {
                inside: !0
            },
            lineWidth: 1,
        ...
        }), ak.compose = al.compose, ay(ak.prototype, {
            pointValKey: "y",
            showLine: !0,
            pointClass: ap
        }), au(ak, "afterColumnTranslate", function() {
            let { options: t, points: e, yAxis: i } = this, s = av(t.minPointLength, 5), a = s / 2, o = t.threshold || 0, r = t.stacking, n = i.waterfall?.stacks[this.stackKey], l = this.getColumn("y", !0), h = o, p = o, d, c, u, g;
            for(let t = 0; t < e.length; t++){
                let f = e[t], m = l[t], b = ay({
                    x: 0,
                    y: 0,
                    width: 0,
                    height: 0
                ...
                if (r) {
                    if (n) {
                        let e = n[t];
                        "overlap" === r ? (c = e.stackState[e.stateIndex--], d = x >= 0 ? c : c - x, aL(e, "absolutePos") && delete e.absolutePos, aL(e, "absoluteNeg") && delete e.absoluteNeg) : (x >= 0 ? (c = e.threshold + e.posTotal, e.posTotal -= x, d = c) : (c = e.threshold + e.negTotal, e.negTotal -= x, d = c - x), !e.posTotal && ax(e.absolutePos) && aL(e, "absolutePos") && (e.posTotal = e.absolutePos, delete e.absolutePos), !e.negTotal && ax(e.absoluteNeg) && aL(e, "absoluteNeg") && (e.negTotal = e.absoluteNeg, delete e.absoluteNeg)), f.isSum || (e.connectorThreshold = e.threshold + e.stackTotal), i.reversed ? (u = x >= 0 ? d - x : d + x, g = d) : (u = d, g = d - x), f.below = u <= o, b.y = i.translate(u, !1, !0, !1, !0), b.height = Math.abs(b.y - i.translate(g, !1, !0, !1, !0));
                ...
                } else d = Math.max(p, p + x) + y[0], b.y = i.translate(d, !1, !0, !1, !0), f.isSum ? (b.y = i.translate(y[1], !1, !0, !1, !0), b.height = Math.min(i.translate(y[0], !1, !0, !1, !0), i.len) - b.y, f.below = y[1] <= o) : f.isIntermediateSum ? (x >= 0 ? (u = y[1] + h, g = h) : (u = h, g = y[1] + h), i.reversed && (u ^= g, g ^= u, u ^= g), b.y = i.translate(u, !1, !0, !1, !0), b.height = Math.abs(b.y - Math.min(i.translate(g, !1, !0, !1, !0), i.len)), h += y[1], f.below = u <= o) : (b.height = m > 0 ? i.translate(p, !1, !0, !1, !0) - b.y : i.translate(p, !1, !0, !1, !0) - i.translate(p - m, !1, !0, !1, !0), f.below = (p += m) < o), b.height < 0 && (b.y += b.height, b.height *= -1);
                f.plotY = b.y, f.yBottom = b.y + b.height, b.height <= s && !f.isNull ? (b.height = s, b.y -= a, f.yBottom = b.y + b.height, f.plotY = b.y, x < 0 ? f.minPointLengthOffset = -a : f.minPointLengthOffset = a) : (f.isNull && (b.width = 0), f.minPointLengthOffset = 0);
                let P = f.plotY + (f.negative ? b.height : 0);
                f.below && (f.plotY += b.height), f.tooltipPos && (this.chart.inverted ? f.tooltipPos[0] = i.len - P : f.tooltipPos[1] = P), f.isInside = this.isPointInside(f);
                let M = ab(f.yBottom, this.borderWidth);
                b.y = ab(b.y, this.borderWidth), b.height = M - b.y, aP(!0, f.shapeArgs, b);
            }
        }, {
            order: 2
        }), M().registerSeriesType("waterfall", ak);
        let aw = x();
...
//# sourceMappingURL=node_modules_09bf3028._.js.map