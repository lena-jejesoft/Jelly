...
"[project]/node_modules/highcharts/es-modules/Core/Chart/Chart.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * */ 'use strict';
;
const { animate, animObject, setAnimation } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Animation$2f$AnimationUtilities$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"];
;
;
...
;
const { numberFormat } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Templating$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"];
;
...
;
const { charts, doc, marginNames, svg, win } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Globals$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"];
;
;
;
...
;
;
const { addEvent, attr, createElement, css, defined, diffObjects, discardElement, erase, error, extend, find, fireEvent, getAlignFactor, getStyle, isArray, isNumber, isObject, isString, merge, objectEach, pick, pInt, relativeLength, removeEvent, splat, syncTimeout, uniqueKey } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Utilities$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"];
/* *
 *
 *  Class
 *
 ...
 */ class Chart {
    ...
    // Implementation
    constructor(a, /* eslint-disable @typescript-eslint/no-unused-vars */ b, c){
        /** @internal */ this.sharedClips = {};
        const args = [
     ...
     */ init(userOptions, callback) {
        ...
        fireEvent(this, 'init', {
            ...
            if (!(this.renderTo = isString(renderTo) ? doc.getElementById(renderTo) : renderTo)) {
             ...
             */ this.series = [];
            this.locale = options.lang.locale ?? this.renderTo.closest('[lang]')?.lang;
            /**
             ...
             */ this.time = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Time$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"](extend(options.time || {}, {
                locale: this.locale
            }), options.lang);
            ...
            charts.push(chart);
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Globals$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].chartCount++;
     ...
     */ orderItems(coll, fromIndex = 0) {
        const collection = this[coll], // Item options should be reflected in chart.options.series,
        // chart.options.yAxis etc
        optionsArray = this.options[coll] = splat(this.options[coll]).slice(), userOptionsArray = this.userOptions[coll] = this.userOptions[coll] ? splat(this.userOptions[coll]).slice() : [];
        if (this.hasRendered) {
        ...
        if (collection) {
            for(let i = fromIndex, iEnd = collection.length; i < iEnd; ++i){
                ...
                if (item) {
                     ...
                     * @readonly
                     */ item.index = i;
                    if (item instanceof __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Series$2f$Series$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"]) {
     ...
     */ get(id) {
        ...
        /** @internal */ function itemById(item) {
     ...
     */ createAxes() {
        ...
        for (const coll of [
            ...
            for (const axisOptions of arr){
                ...
                new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Axis$2f$Axis$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"](this, axisOptions, coll);
            }
        }
     ...
     */ applyDescription(key, explicitOptions) {
        ...
        if (options && !elem) {
            ...
            elem.css({
                whiteSpace: options.style?.whiteSpace
            });
            /**
     ...
     */ layOutTitles(redraw = true) {
        ...
        [
            ...
            if (desc && descOptions) {
                ...
                fireEvent(this, 'layOutTitle', {
                    alignTo,
                    key,
                    textPxLength
                });
                const fontMetrics = renderer.fontMetrics(desc), baseline = fontMetrics.b, lineHeight = fontMetrics.h, verticalAlign = descOptions.verticalAlign || 'top', topAligned = verticalAlign === 'top', // Use minScale only for top-aligned titles. It is not
                ...
                minScale = topAligned && descOptions.minScale || 1, offset = key === 'title' ? topAligned ? -3 : 0 : // Floating subtitle (#6574)
                topAligned ? titleOffset[0] + 2 : 0, uncappedScale = Math.min(alignTo.width / textPxLength, 1), scale = Math.max(minScale, uncappedScale), alignAttr = merge({
                    ...
                    align: key === 'title' ? uncappedScale < minScale ? 'left' : 'center' : // Subtitle defaults to the title.align
                    this.title?.alignValue
                }, descOptions), width = (descOptions.width || (uncappedScale > minScale ? // One line
                this.chartWidth : // Allow word wrap
                ...
                const height = Math.round(desc.css({
                    width
                ...
                desc.align(alignAttr, false, alignTo).attr({
                    ...
                    scaleX: scale,
                    scaleY: scale,
                    'transform-origin': `${alignTo.x + textPxLength * scale * getAlignFactor(alignAttr.align)} ${lineHeight}`
                });
                // Adjust the rendered title offset
                if (!descOptions.floating) {
                    const offset = height * (// When scaling down the title, preserve the offset as
        ...
        if (titleOffset[0] && (options.title?.verticalAlign || 'top') === 'top') {
            titleOffset[0] += options.title?.margin || 0;
        }
        if (titleOffset[2] && options.caption?.verticalAlign === 'bottom') {
     ...
     */ getChartSize() {
        const chart = this, optionsChart = chart.options.chart, widthOption = optionsChart.width, heightOption = optionsChart.height, containerBox = chart.getContainerBox(), enableDefaultHeight = containerBox.height <= 1 || !chart.renderTo.parentElement?.style.height && chart.renderTo.style.height === '100%';
        /**
         * The current pixel width of the chart.
         *
         * @name Highcharts.Chart#chartWidth
         * @type {number}
         */ chart.chartWidth = Math.max(0, widthOption || containerBox.width || 600 // #1460
        );
        /**
         ...
         * @type {number}
         */ chart.chartHeight = Math.max(0, relativeLength(heightOption, chart.chartWidth) || (enableDefaultHeight ? 400 : containerBox.height));
     ...
     */ getContainer() {
        ...
        renderTo.innerHTML = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Renderer$2f$HTML$2f$AST$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].emptyHTML;
        ...
        const Renderer = optionsChart.renderer || !svg ? __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Renderer$2f$RendererRegistry$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].getRendererType(optionsChart.renderer) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Renderer$2f$SVG$2f$SVGRenderer$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"];
        /**
     ...
     */ getAxisMargins() {
        const chart = this, // [top, right, bottom, left]
        axisOffset = chart.axisOffset = [
            0,
            0,
            0,
            0
        ], colorAxis = chart.colorAxis, margin = chart.margin, getOffset = (axes)=>{
            axes.forEach((axis)=>{
                if (axis.visible) {
                    axis.getOffset();
                }
     ...
     */ reflow(e) {
        ...
        if (!chart.exporting?.isPrinting && !chart.isResizing && oldBox && // When fired by resize observer inside hidden container
        containerBox.width) {
            if (containerBox.width !== oldBox.width || containerBox.height !== oldBox.height) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Utilities$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].clearTimeout(chart.reflowTimeout);
     ...
     */ resetMargins() {
        ...
        [
            ...
            const value = chartOptions[target], values = isObject(value) ? value : [
                value,
                value,
                value,
                value
            ...
            [
                ...
                chart[target][side] = chartOptions[`${target}${sideName}`] ?? values[side];
            });
        });
     ...
     */ drawChartBox() {
        ...
        plotBorder[verb](plotBorder.crisp(plotBox, // #3282 plotBorder should be negative
     ...
     */ propFromSeries() {
         ...
         */ [
            ...
            optionsChart[key] || klass && klass.prototype[key];
            // Requires it
     ...
     */ linkSeries(isUpdating) {
        ...
        // Apply new links
        chartSeries.forEach(function(series) {
            const { linkedTo } = series.options, linkedParent = isString(linkedTo) && (linkedTo === ':previous' ? chartSeries[series.index - 1] : chart.get(linkedTo));
            if (linkedParent && // #3341 avoid mutual linking
            linkedParent.linkedParent !== series) {
                ...
                series.visible = series.options.visible ?? linkedParent.options.visible ?? series.visible; // #3879
            }
        });
     ...
     */ render() {
        ...
        let expectedSpace = 0, // If the plot area size has changed significantly, calculate tick
        // positions again
        ...
        for (const axis of axes){
            ...
            axis.horiz && axis.visible && labels.enabled && axis.series.length && axis.coll !== 'colorAxis' && !chart.polar) {
                ...
                const mockTick = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Axis$2f$Tick$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"](axis, 0, '', true), label = mockTick.createLabel('x', labels);
                mockTick.destroy();
                if (label && pick(labels.reserveSpace, !isNumber(options.crossing))) {
        ...
        while((redoHorizontal || redoVertical || axisLayoutRuns > 1) && run < axisLayoutRuns // #19794
        ){
     ...
     */ destroy() {
        ...
        if (container) {
            container.innerHTML = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Renderer$2f$HTML$2f$AST$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].emptyHTML;
     ...
     */ createAxis(coll, options) {
        const axis = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Axis$2f$Axis$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"](this, options.axis, coll);
     ...
     */ showLoading(str) {
        ...
        // Update text
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Renderer$2f$HTML$2f$AST$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].setElementHTML(loadingSpan, pick(str, options.lang.loading, ''));
        if (!chart.styledMode) {
            // Update visuals
     ...
     */ update(options, redraw, oneToOne, animation) {
            ...
            if (options[coll]) {
                splat(options[coll]).forEach(function(newOptions, i) {
                    ...
                    if (!item && oneToOne && chart.collectionsWithInit[coll]) {
                        chart.collectionsWithInit[coll][0].apply(chart, // [newOptions, ...extraArguments, redraw=false]
                        [
                            newOptions
                        ].concat(// Not all initializers require extra args
        ...
        if (// In this case, run chart.setSize with newWidth and newHeight which
        // are undefined, only for reflowing chart elements because margin
        // or spacing has been set (#8190)
        runSetSize || isNumber(newWidth) && newWidth !== chart.chartWidth || isNumber(newHeight) && newHeight !== chart.chartHeight) {
     ...
     */ showResetZoom() {
        const chart = this, lang = defaultOptions.lang, btnOptions = chart.zooming.resetButton, theme = btnOptions.theme, alignTo = btnOptions.relativeTo === 'chart' || btnOptions.relativeTo === 'spacingBox' ? null : 'plotBox';
        /** @internal */ function zoomOut() {
            chart.zoomOut();
        }
     ...
     */ transform(params) {
        ...
        for (const axis of axes){
            const { horiz, len, minPointOffset = 0, options, reversed } = axis, wh = horiz ? 'width' : 'height', xy = horiz ? 'x' : 'y', toLength = pick(to[wh], axis.len), fromLength = pick(from[wh], axis.len), // If fingers pinched very close on this axis, treat as pan
            scale = Math.abs(toLength) < 10 ? 1 : toLength / fromLength, fromCenter = (from[xy] || 0) + fromLength / 2 - axis.pos, toCenter = (to[xy] ?? axis.pos) + toLength / 2 - axis.pos, move = fromCenter - toCenter / scale, pointRangeDirection = reversed && !inverted || !reversed && inverted ? -1 : 1, minPx = move;
            ...
            // (#22945)
            const offset = axis.chart.polar || axis.isOrdinal ? 0 : minPointOffset * pointRangeDirection || 0, eventMin = axis.toValue(minPx, true), eventMax = axis.toValue(minPx + len / scale, true);
            ...
            if (scale === 1 && !reset && axis.coll === 'yAxis' && !allExtremes) {
                for (const series of axis.series){
                    const seriesExtremes = series.getExtremes(series.getProcessedData(true).modified.getColumn(series.pointValKey || 'y') || [], true);
                    allExtremes ?? (allExtremes = {
                        dataMin: Number.MAX_VALUE,
                        dataMax: -Number.MAX_VALUE
                    });
                    if (isNumber(seriesExtremes.dataMin) && isNumber(seriesExtremes.dataMax)) {
            ...
            const { dataMin, dataMax, min, max } = extend(axis.getExtremes(), allExtremes || {}), optionsMin = time.parse(options.min), optionsMax = time.parse(options.max), // For boosted chart where data extremes are skipped
            safeDataMin = dataMin ?? optionsMin, safeDataMax = dataMax ?? optionsMax, range = newMax - newMin, padRange = axis.categories ? 0 : Math.min(range, safeDataMax - safeDataMin), paddedMin = safeDataMin - padRange * (defined(optionsMin) ? 0 : options.minPadding), paddedMax = safeDataMax + padRange * (defined(optionsMax) ? 0 : options.maxPadding), // We're allowed to zoom outside the data extremes if we're
            // dealing with a bubble chart, if we're panning, or if we're
            // pinching or mousewheeling in.
            allowZoomOutside = axis.allowZoomOutside || scale === 1 || trigger !== 'zoom' && scale > 1, // Calculate the floor and the ceiling
            ...
            if (!axis.isOrdinal || scale !== 1 || reset) {
                ...
                if (reset || axis.series.length && (newMin !== min || newMax !== max) && newMin >= floor && newMax <= ceiling) {
                    if (selection) {
                        ...
                        axis.setExtremes(reset ? void 0 : newMin, reset ? void 0 : newMax, false, false, {
                            move,
                            trigger,
                            scale
                        });
                ...
                if (!this.hasCartesianSeries && !reset) {
                    displayButton = allowResetButton;
                }
                if (event) {
        ...
        if (hasZoomed) {
            if (selection) {
                fireEvent(this, 'selection', selection, // Run transform again, this time without the selection data
...
"[project]/node_modules/highcharts/es-modules/Core/Chart/StockChart.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const { getOptions } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Defaults$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"];
;
;
;
;
...
;
const { addEvent, clamp, crisp, defined, extend, find, isNumber, isString, merge, pick, splat } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Utilities$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"];
/* *
 *
 *  Functions
 *
 ...
 */ function getForcedAxisOptions(type, chartOptions) {
    if (type === 'xAxis') {
        ...
        // is enabled (#1090)
        const navigatorEnabled = pick(chartOptions.navigator?.enabled, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Stock$2f$Navigator$2f$NavigatorDefaults$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].enabled, true);
        const axisOptions = {
            type: 'datetime',
            categories: void 0
        };
 ...
 */ class StockChart extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Chart$2f$Chart$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    /* *
     *
     *  Functions
     *
     ...
     */ init(userOptions, callback) {
        const defaultOptions = getOptions(), xAxisOptions = userOptions.xAxis, yAxisOptions = userOptions.yAxis, // Always disable startOnTick:true on the main axis when the
        // navigator is enabled (#1090)
        navigatorEnabled = pick(userOptions.navigator?.enabled, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Stock$2f$Navigator$2f$NavigatorDefaults$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].enabled, true);
        ...
        const options = merge({
            ...
            scrollbar: {
                ...
                enabled: pick(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Stock$2f$Scrollbar$2f$ScrollbarDefaults$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].enabled, true)
            },
            rangeSelector: {
                // #4988 - check if setOptions was called
                enabled: pick(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Stock$2f$RangeSelector$2f$RangeSelectorDefaults$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].rangeSelector.enabled, true)
            },
            title: {
                text: null
            },
        ...
        options.xAxis = splat(userOptions.xAxis || {}).map((xAxisOptions)=>merge(getDefaultAxisOptions('xAxis', xAxisOptions, defaultOptions.xAxis), // #7690
            xAxisOptions, getForcedAxisOptions('xAxis', userOptions)));
        // Apply Y axis options to both single and multi y axes
        options.yAxis = splat(userOptions.yAxis || {}).map((yAxisOptions)=>merge(getDefaultAxisOptions('yAxis', yAxisOptions, defaultOptions.yAxis), // #7690
...
addEvent(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Chart$2f$Chart$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], 'update', function(e) {
    ...
    if ('scrollbar' in options && chart.navigator) {
        ...
        chart.navigator.update({
            enabled: !!chart.navigator.navigatorEnabled
        });
 ...
 * */ /** @internal */ (function(StockChart) {
     ...
     */ function onAxisAfterDrawCrosshair(event) {
        ...
        if (!(axis.crosshair?.label?.enabled && axis.cross && isNumber(axis.min) && isNumber(axis.max))) {
            return;
        }
        const chart = axis.chart, log = axis.logarithmic, options = axis.crosshair.label, horiz = axis.horiz, opposite = axis.opposite, left = axis.left, top = axis.top, width = axis.width, tickInside = axis.options.tickPosition === 'inside', snap = axis.crosshair.snap !== false, e = event.e || axis.cross?.e, point = event.point;
        let crossLabel = axis.crossLabel, posx, posy, formatOption = options.format, formatFormat = '', limit, offset = 0, // Use last available event (#5287)
        ...
        if (!crossLabel) {
            crossLabel = axis.crossLabel = chart.renderer.label('', 0, void 0, options.shape || 'callout').addClass('highcharts-crosshair-label highcharts-color-' + (point?.series ? point.series.colorIndex : axis.series[0] && this.series[0].colorIndex)).attr({
            ...
            if (!chart.styledMode) {
                crossLabel.attr({
                    fill: options.backgroundColor || point?.series?.color || // #14888
        ...
        const isInside = point?.series ? point.series.isPointInside(point) : isNumber(value) && value > min && value < max;
        let text = '';
        if (formatOption) {
     ...
     */ function onAxisGetPlotLinePath(e) {
        const axis = this, series = axis.isLinked && !axis.series && axis.linkedParent ? axis.linkedParent.series : axis.series, { chart, horiz } = axis, renderer = chart.renderer, result = [], { acrossPanes = true, force, translatedValue, value } = e, allPerpendicularAxes = (axis.isXAxis ? chart.yAxis : chart.xAxis) || [], /**
         ...
         */ function pushSegment(pos, crossingPos1, crossingPos2) {
            result.push([
                'M',
                horiz ? pos : crossingPos1,
                horiz ? crossingPos1 : pos
            ], [
                'L',
                horiz ? pos : crossingPos2,
                horiz ? crossingPos2 : pos
            ]);
        }
        let axes = [], uniqueAxes, transVal;
        if (chart.options.isStock && // Ignore in case of colorAxis or zAxis. #3360, #3524, #6720
        (axis.coll === 'xAxis' || axis.coll === 'yAxis')) {
            ...
            for (const A of allPerpendicularAxes){
                if (!A.options.isInternal) {
                    const a = A.isXAxis ? 'yAxis' : 'xAxis', relatedAxis = defined(A.options[a]) && chart[a][A.options[a]];
                    if (axis === relatedAxis) {
                        axes.push(A);
                    }
                }
            ...
            uniqueAxes = axes.length ? [] : [
                axis.isXAxis ? chart.yAxis[0] : chart.xAxis[0]
            ]; // #3742
            for (const axis2 of axes){
                if (uniqueAxes.indexOf(axis2) === -1 && // Do not draw on axis which overlap completely. #5424
                !find(uniqueAxes, (unique)=>unique.pos === axis2.pos && unique.len === axis2.len)) {
                    uniqueAxes.push(axis2);
                }
            }
            transVal = pick(translatedValue, axis.translate(value || 0, void 0, void 0, e.old));
            if (isNumber(transVal)) {
                let skip, pos = horiz ? transVal + axis.pos : axis.pos + axis.len - transVal;
                // Outside plot area
                if (force !== 'pass' && (pos < axis.pos || pos > axis.pos + axis.len)) {
                    if (force) {
                ...
                if (!skip) {
                    ...
                    if (!acrossPanes && // If the perpendicular position is set explicitly on
                    ...
                    (axis.options[crossingPosName] || axis.options[crossingLenName])) {
            ...
            e.path = result.length > 0 ? renderer.crispPolyLine(result, e.lineWidth || 1) : // #3557 getPlotLinePath in regular Highcharts also returns null
            void 0;
        }
    }
    /**
     ...
     */ function seriesForceCropping() {
        const series = this, chart = series.chart, options = series.options, dataGroupingOptions = options.dataGrouping, groupingEnabled = series.allowDG !== false && dataGroupingOptions && pick(dataGroupingOptions.enabled, chart.options.isStock);
...
//# sourceMappingURL=node_modules_highcharts_es-modules_Core_Chart_0697cee5._.js.map