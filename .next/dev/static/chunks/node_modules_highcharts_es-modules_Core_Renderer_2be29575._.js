...
"[project]/node_modules/highcharts/es-modules/Core/Renderer/RendererUtilities.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
 ...
 * */ 'use strict';
;
const { clamp, pick, pushUnique, stableSort } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Utilities$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"];
/* *
 *
 *  Namespace
 *
 * */ /** @internal */ var RendererUtilities;
...
const __TURBOPACK__default__export__ = RendererUtilities;
}),
...
"[project]/node_modules/highcharts/es-modules/Core/Renderer/HTML/HTMLElement.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
;
const { composed, isFirefox } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Globals$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"];
;
;
const { attr, css, createElement, defined, extend, getAlignFactor, isNumber, pInt, pushUnique } = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Utilities$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"];
/**
 ...
 */ function commonSetter(value, key, elem) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Renderer$2f$SVG$2f$SVGElement$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].prototype[`${key}Setter`].call(this, value, key, elem);
    if (style) {
 ...
 */ const decorateSVGGroup = (g, container)=>{
    if (!g.div) {
        ...
        // Event handling
        g.on = function() {
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Renderer$2f$SVG$2f$SVGElement$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].prototype.on.apply({
                element: div,
                onEvents: g.onEvents
            }, arguments);
            return g;
 ...
 *  Class
 *
 * */ class HTMLElement extends __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Renderer$2f$SVG$2f$SVGElement$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"] {
    /**
     * Compose
     * @internal
     */ static compose(SVGRendererClass) {
        if (pushUnique(composed, this.compose)) {
             ...
             */ SVGRendererClass.prototype.html = function(str, x, y) {
                return new HTMLElement(this, 'span')// Set the default attributes
                .attr({
                    text: str,
                    x: Math.round(x),
                    y: Math.round(y)
     ...
     * @internal
     */ css(styles) {
        const { element } = this, // When setting or unsetting the width style, we need to update
        // transform (#8809)
        isSettingWidth = element.tagName === 'SPAN' && styles && 'width' in styles, textWidth = isSettingWidth && styles.width;
        let doTransform;
        if (isSettingWidth) {
            delete styles.width;
     ...
     */ updateTransform() {
        ...
        if (element.tagName === 'SPAN') {
            ...
            if (textWidth !== oldTextWidth) {
                const textPxLength = getTextPxLength(), textWidthNum = textWidth || 0, willOverWrap = !renderer.styledMode && element.style.textOverflow === '' && element.style.webkitLineClamp;
                ...
                /[\-\s\u00AD]/.test(element.textContent || element.innerText) || element.style.textOverflow === 'ellipsis')) {
                    ...
                    willOverWrap;
                    css(element, {
                        width: usePxWidth && isNumber(textWidth) ? textWidth + 'px' : 'auto',
                        display,
            ...
            if (currentTextTransform !== this.cTT) {
                ...
                if (defined(rotation) && !foreignObject && (rotation !== (this.oldRotation || 0) || textAlign !== this.oldAlign)) {
                ...
                this.getSpanCorrection(!defined(rotation) && !this.textWidth && this.textPxLength || // #7920
     ...
     */ add(parentGroup) {
        ...
        if (foreignObject) {
            ...
            super.add(// Create a body inside the foreignObject
            renderer.createElement('body').attr({
     ...
     */ textSetter(value) {
        if (value !== this.textStr) {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$highcharts$2f$es$2d$modules$2f$Core$2f$Renderer$2f$HTML$2f$AST$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].setElementHTML(this.element, value ?? '');
            this.textStr = value;
            this.doTransform = true;
        }
    }
...
const __TURBOPACK__default__export__ = HTMLElement;
}),
]);

//# sourceMappingURL=node_modules_highcharts_es-modules_Core_Renderer_2be29575._.js.map